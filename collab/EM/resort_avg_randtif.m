...
for count_run = 1:length(userun)
   ...
   % Nstim1 = min(size(Seq,1),Nframes1./(Ntot1)); %%NOTE : CHECK THIS
    ...
    if count_run == 1
        ...
        Big_Seqposition.TFSFetc = Stimvec;
    end
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fn_out = [PWD_analysis, file_USE(1:(ind(1)-1)), '_Seqposition.mat'];
    save(fn_out, 'Seqposition');

    fn_out = [PWD_analysis, file_USE(1:(ind(1)-2)), num2str(userun) '_Big_Seqposition.mat'];
