function [bwCell_vol_numbered] = imCellEditInteractive_3DMA_090210(fovImg_vol, bwCell_vol_numbered, zoomToAxis, cellRadius, Im_contrast)
    ...
    if isnan(X) 
        ...
        switch key
          ...
          case 'zzz' 
            ...
            subDrawShaded(fovImg_view, bwCurr, zoomToAxis, X, Y + X_skip, Z1, nRows0, nCols0, nZ, MINMAX, bwCell_vol);
...
%        Zproj = squeeze(max(bwCell_vol,[],3));
        ...
        % draw the new version
        subDrawShaded(fovImg_view, bwCurr_view, zoomToAxis, X, Y + X_skip, Z1, nRows0, nCols0, nZ, MINMAX, bwCell_vol);
