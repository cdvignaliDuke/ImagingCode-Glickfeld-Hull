...
data_dir='\\zmey\storlab\data\Soumya\scmr7';
tif_dir=[data_dir,'\tif'];

map_root_dir = 'E:\users\kenichi\scmr7\pixelmaps';
label_dir = 'E:\users\kenichi\scmr7\labelimg'
for i=[1:36,39:length(s)]
    fname=s(i).filename;
    if fname(1)=='r'
        fname(1)=[];
    end
    ...
    for stim=1:s(i).Nstim_per_run
     ...
     print ('-dpsc2', '-append','scmr7_maps.ps');
fclose all
