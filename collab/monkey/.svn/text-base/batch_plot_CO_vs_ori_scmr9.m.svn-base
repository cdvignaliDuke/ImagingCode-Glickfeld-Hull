...
label_dir = '\\zmey\storlab\data\Soumya\scmr9\labelimg'
CO_dir='\\zmey\storlab\users\monkey_archive\CO analysis files\scmr9\canonical';
COname='scmr9_FOV';

outfname='plot_CO_vs_ori_scmr9.ps';
