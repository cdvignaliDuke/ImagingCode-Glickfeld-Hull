filelist='exp_list_scmr5_2_conecycle.xls';
s=readXLSfilelist(filelist);

map_root_dir = '\\zmey\storlab\users\monkey_archive\maps\conemaps\scmr5';
data_dir='\\zmey\storlab\data\Soumya\scmr5\';

outfname='E:\users\kenichi\cone_tcourses_scmr5.ps';
