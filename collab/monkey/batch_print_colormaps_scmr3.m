filelist='exp_list_scmr3_2.xls';
s=readXLSfilelist(filelist);

map_root_dir = '\\zmey\storlab\users\kenichi\monkey\colormaps\scmr3';
data_dir='\\zmey\storlab\data\Soumya\scmr3\';

outfname='colormaps_scmr3.ps';
