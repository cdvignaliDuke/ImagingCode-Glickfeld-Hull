...
ops0.toolbox_path = 'C:\Users\ashley\Documents\Repositories\Suite2P_Updated';
...
ops0.RootStorage            = 'D:\Ashley_temp\suite2Ptest'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = 'D:\Ashley_temp\suite2Ptest'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = 'D:\Ashley_temp\suite2Ptest';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = 'D:\Ashley_temp\suite2Ptest'; % a folder structure is created inside
...
ops0.recomputeKernel        = 0; % whether to re-estimate kernel during optimization (default kernel is "reasonable", if you give good timescales)
