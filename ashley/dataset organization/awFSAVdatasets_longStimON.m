...
% expt(4).img_loc  = {'V1';'L2/3'};
% expt(4).img_strct  = {'cells'};
% expt(4).time_mat = ['1116'; '1135'; '1151'; '1210'];
% expt(4).runs = ['001'; '002'; '003'; '004'];
% expt(4).nrun = size(expt(4).runs,1);
% expt(4).frame_rate = 30;
% expt(4).folder = 'two-photon imaging';
...
%% AW26 160121 - suppressed avg response, very few cells good behavior
expt(6).SubNum = '626';
expt(6).mouse = 'AW26';
expt(6).date = '160121';
expt(6).img_loc  = {'V1';'L2/3'};
expt(6).img_strct  = {'cells'};
expt(6).time_mat = ['1045'; '1100'; '1117'; '1133'];
