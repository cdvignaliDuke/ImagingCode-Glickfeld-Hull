...
expt(1).time_mat = ['1056'; '1111'; '1127'];
...
expt(3).mouse = 'AW70';
expt(3).date = '170330';
expt(3).img_loc  = {'PM';'L1'};
expt(3).img_strct  = {'axons'};
expt(3).time_mat = ['1219'];
expt(3).runs = ['001'];
...
expt(3).dirtuning_time = '1306';
expt(3).rettuning = {'004';'1317'};
...
expt(4).mouse = 'AW70';
expt(4).date = '170403';
expt(4).img_loc  = {'PM';'L1'};
expt(4).img_strct  = {'axons'};
expt(4).time_mat = ['1017'];
expt(4).runs = ['001'];
...
expt(4).dirtuning_time = '1101';
expt(4).rettuning = {'004';'1109'};
...
% expt(2).img_loc  = {'PM';'L2/3'};
% expt(2).img_strct  = {'axons'};
% expt(2).time_mat = ['1022'; '1039'; '1054'];
...
% expt(2).rettuning = {'004';'1111'};
% expt(2).motionTestBimodal = 0;

% %% AW16 151211 FA rate high
% 
% expt(3).SubNum = '616';
% expt(3).mouse = 'AW16';
% expt(3).date = '151211';
...
% expt(3).img_strct  = {'axons'};
% expt(3).time_mat = ['1049'; '1105'; '1120'];
...
% expt(3).rettuning = {'004';'1138'};
% expt(3).motionTestBimodal = 0;

% %% AW16 151214 FA rate high
% 
% expt(4).SubNum = '616';
% expt(4).mouse = 'AW16';
% expt(4).date = '151214';
