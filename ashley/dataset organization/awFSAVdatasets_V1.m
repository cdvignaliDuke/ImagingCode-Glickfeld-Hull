...
expt(10).time_mat = ['1047'; '1103'; '1119'];
expt(10).runs = ['001'; '002'; '003'];
...
expt(10).rettuning = {'004';'1140'};
expt(10).motionTestBimodal = 0;
expt(10).stimOnMs = 200;
...
% expt(11).time_mat = ['1453'; '1509'; '1525'; '1541'];
...
% expt(11).dirtuning_time = '1602';
% expt(11).rettuning = {'005'; '1558'};
% expt(11).motionTestBimodal = 0;
% expt(11).stimOnMs = 200;
...
% expt(11).img_loc  = {'V1';'L2/3'};
% expt(11).img_strct  = {'cells'};
% expt(11).time_mat = ['1617'; '1650'; '1707'];
% expt(11).runs = ['003'; '004'; '005'];
% expt(11).nrun = size(expt(11).runs,1);
% expt(11).frame_rate = 30;
% expt(11).folder = 'two-photon imaging';
% expt(11).catch = 1;
% expt(11).dirtuning = '007';
% expt(11).dirtuning_time = '1729';
% expt(11).rettuning = {'006'; '1724'};
% expt(11).motionTestBimodal = 0;
% expt(11).stimOnMs = 200;
...
% expt(11).img_loc  = {'V1';'L2/3'};
% expt(11).img_strct  = {'cells'};
% expt(11).time_mat = ['1335'; '1350'; '1407'];
% expt(11).runs = ['003'; '004'; '006'];
% expt(11).nrun = size(expt(11).runs,1);
% expt(11).frame_rate = 30;
% expt(11).folder = 'two-photon imaging';
% expt(11).catch = 1;
% expt(11).dirtuning = '008';
% expt(11).dirtuning_time = '1435';
% expt(11).rettuning = {'007';'1424'};
% expt(11).motionTestBimodal = 0;
% expt(11).stimOnMs = 200;
...
expt(11).img_loc  = {'V1';'L2/3'};
expt(11).img_strct  = {'cells'};
expt(11).time_mat = ['1113';'1130'];%'1040'; '1057';
expt(11).runs = ['003';'004'];%'001'; '002';
expt(11).nrun = size(expt(11).runs,1);
expt(11).frame_rate = 30;
expt(11).folder = 'two-photon imaging';
expt(11).catch = 1;
expt(11).catchRew = 1;
expt(11).dirtuning = '006';
expt(11).dirtuning_time = '1150';
expt(11).rettuning = {'005';'1146'};
expt(11).motionTestBimodal = 0;
expt(11).z = 281;
expt(11).stimOnMs = 200;
%% AW25 160309
...
expt(12).time_mat = ['1346';'1402';'1421';'1437'];%
expt(12).runs = ['006';'007';'008';'009'];% 
expt(12).nrun = size(expt(12).runs,1);
expt(12).frame_rate = 30;
expt(12).folder = 'two-photon imaging';
expt(12).catch = 1;
expt(12).catchRew = 1;
expt(12).dirtuning = '011';
expt(12).dirtuning_time = '1457';
expt(12).rettuning = {'010';'1453'};
expt(12).motionTestBimodal = 0;
expt(12).z = 244;
expt(12).stimOnMs = 200;
...
% expt(13).time_mat = ['1026'; '1042';'1058'];%'1005'; 
% expt(13).runs = ['002'; '003';'004'];%'001'; 
% expt(13).nrun = size(expt(13).runs,1);
% expt(13).frame_rate = 30;
% expt(13).folder = 'two-photon imaging';
% expt(13).catch = 1;
% expt(13).dirtuning = '006';
% expt(13).dirtuning_time = '1121';
% expt(13).rettuning = {'005';'1116'};
% expt(13).motionTestBimodal = 0;
% expt(13).z = 237;
% expt(13).stimOnMs = 200;
...
expt(13).img_loc  = {'V1';'L2/3'};
expt(13).img_strct  = {'cells'};
expt(13).time_mat = ['1042';'1058';'1115';'1131'];
expt(13).runs = ['001';'002';'003';'005'];
expt(13).nrun = size(expt(13).runs,1);
expt(13).frame_rate = 30;
expt(13).folder = 'two-photon imaging';
expt(13).catch = 1;
expt(13).catchRew = 1;
expt(13).dirtuning = '006';
expt(13).dirtuning_time = '1147';
expt(13).rettuning = {'007';'1156'};
expt(13).motionTestBimodal = 0;
expt(13).z = 203;
...
expt(14).time_mat = ['1130';'1146';'1202'];
...
expt(14).dirtuning_time = '1231';
expt(14).rettuning = {'007';'1246'};
...
expt(15).time_mat = ['1230';'1246';'1302';'1318'];
...
expt(15).dirtuning_time = '1335';
expt(15).rettuning = {'006';'1344'};
...
expt(16).img_loc  = {'V1';'L2/3'};
expt(16).img_strct  = {'cells'};
expt(16).time_mat = ['1448';'1504';'1525'];
expt(16).runs = ['003';'004';'005'];
expt(16).nrun = size(expt(16).runs,1);
expt(16).frame_rate = 30;
expt(16).folder = 'two-photon imaging';
expt(16).catch = 1;
...
expt(16).dirtuning_time = '1559';
expt(16).rettuning = {'007';'1613'};
expt(16).motionTestBimodal = 0;
expt(16).z = 244;
...
expt(17).time_mat = ['1130';'1145';'1201';'1217'];
expt(17).runs = ['001';'002';'003';'004'];
expt(17).nrun = size(expt(17).runs,1);
expt(17).frame_rate = 30;
expt(17).folder = 'two-photon imaging';
expt(17).catch = 1;
expt(17).catchRew = 1;
expt(17).dirtuning = '007';
expt(17).dirtuning_time = '1235';
expt(17).rettuning = {'008';'1244'};
...
expt(18).time_mat = ['1010';'1025';'1041'];
expt(18).runs = ['002';'003';'004'];
expt(18).nrun = size(expt(18).runs,1);
expt(18).frame_rate = 30;
expt(18).folder = 'two-photon imaging';
expt(18).catch = 1;
expt(18).catchRew = 1;
expt(18).dirtuning = '006';
expt(18).dirtuning_time = '1102';
expt(18).rettuning = {'007';'1111'};
expt(18).motionTestBimodal = 0;
expt(18).z = 288;

% % %% AW72 170227 - 100ms %needs to be registered
% % expt(19).SubNum = '672';
% % expt(19).mouse = 'AW72';
% % expt(19).date = '170227';
% % expt(19).img_loc  = {'V1';'L2/3'};
% % expt(19).img_strct  = {'cells'};
% % expt(19).time_mat = ['1132';'1148';'1204';'1221'];
% % expt(19).runs = ['002';'003';'004';'005'];
% % expt(19).nrun = size(expt(19).runs,1);
% % expt(19).frame_rate = 30;
% % expt(19).folder = 'two-photon imaging';
% % expt(19).catch = 1;
% % expt(19).dirtuning = '006';
% % expt(19).dirtuning_time = '1239';
% % expt(19).rettuning = {'007';'1250'};
% % expt(19).motionTestBimodal = 0;
% % expt(19).z = 219;
% % 
% % %% AW72 10301 - 100ms %needs to be registered
% % expt(20).SubNum = '672';
% % expt(20).mouse = 'AW72';
% % expt(20).date = '170301';
% % expt(20).img_loc  = {'V1';'L2/3'};
% % expt(20).img_strct  = {'cells'};
% % expt(20).time_mat = ['0955';'1014';'1036';'1055'];
% % expt(20).runs = ['001';'002';'003';'004'];
% % expt(20).nrun = size(expt(20).runs,1);
% % expt(20).frame_rate = 30;
% % expt(20).folder = 'two-photon imaging';
% % expt(20).catch = 1;
% % expt(20).dirtuning = '006';
% % expt(20).dirtuning_time = '1114';
% % expt(20).rettuning = {'007';'1122'};
% % expt(20).motionTestBimodal = 0;
% % expt(20).z = 219;
...
expt(19).dirtuning_time = '1018';
expt(19).rettuning = {'004';'1027'};
expt(19).motionTestBimodal = 0;
expt(19).z = 252;
...
expt(20).dirtuning_time = '1158';
expt(20).rettuning = {'005';'1208'};
expt(20).motionTestBimodal = 0;
expt(20).z = 256;

% %% AW70 170320 - 100ms %needs to be registered
% expt(21).SubNum = '670';
% expt(21).mouse = 'AW70';
% expt(21).date = '170320';
% expt(21).img_loc  = {'V1';'L2/3'};
% expt(21).img_strct  = {'cells'};
% expt(21).time_mat = ['1111';'1129';'1146'];
% expt(21).runs = ['001';'002';'003'];
...
% expt(21).dirtuning_time = '1224';
% expt(21).rettuning = {'006';'1236'};
% expt(21).motionTestBimodal = 0;
% expt(21).z = 219;
