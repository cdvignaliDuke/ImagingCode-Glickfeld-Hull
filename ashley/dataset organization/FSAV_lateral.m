...
expt(3).time_mat = ['1459'; '1515'; '1532';'1548'];
expt(3).runs = ['002'; '003'; '005';'006'];
...
expt(3).dirtuning_time = '1609';
expt(3).rettuning = {'007'; '1604'};
expt(3).z = [];
expt(3).regImgStartFrame = 89923;
expt(3).trial_range = [];
...
expt(4).time_mat = ['1050';'1106';'1122'];%
...
expt(4).dirtuning_time = '1143';
expt(4).rettuning = {'005';'1139'};
expt(4).motionTestBimodal = 0;
expt(4).z = 213;
expt(4).regImgStartFrame = 67487;
expt(4).trial_range = [];
...
expt(5).time_mat = ['1450'; '1506';'1522';'1538'];%
...
expt(5).rettuning = {'006';'1553'};
expt(5).motionTestBimodal = 0;
expt(5).z = 238;
expt(5).regImgStartFrame = 28143;
expt(5).trial_range = [];
...
expt(6).time_mat = ['1035'; '1056'; '1111';'1127'];
expt(6).runs = ['003'; '005'; '006';'007'];
expt(6).nrun = size(expt(6).runs,1);
expt(6).frame_rate = 30;
expt(6).folder = 'two-photon imaging';
expt(6).catch = 1;
expt(6).catchRew = 1;
expt(6).dirtuning = '009';
expt(6).dirtuning_time = '1147';
expt(6).rettuning = {'008';'1143'};
expt(6).motionTestBimodal = 0;
expt(6).z = 235;
expt(6).regImgStartFrame = 22988;
expt(6).trial_range = [];
