...
expt(2).img_loc  = {'AL';'L2/3'};
expt(2).img_strct  = {'cells'};
expt(2).time_mat = ['1459'; '1515'; '1532';'1548'];
expt(2).runs = ['002'; '003'; '005';'006'];
expt(2).nrun = size(expt(2).runs,1);
expt(2).frame_rate = 30;
expt(2).folder = 'two-photon imaging';
expt(2).catch = 1;
expt(2).dirtuning = '008';
expt(2).dirtuning_time = '1609';
expt(2).rettuning = {'007'; '1604'};
expt(2).motionTestBimodal = 0;
expt(2).nTunFrames = [];
...
expt(3).img_loc  = {'AL';'L2/3'};
expt(3).img_strct  = {'cells'};
expt(3).time_mat = ['1050';'1106';'1122'];%
...
expt(3).dirtuning_time = '1143';
expt(3).rettuning = {'005';'1139'};
expt(3).motionTestBimodal = 0;
expt(3).z = 213;
expt(3).nTunFrames = [];
...
expt(4).time_mat = ['1450'; '1506';'1522';'1538'];%
...
expt(5).time_mat = ['1035'; '1056'; '1111';'1127'];
expt(5).runs = ['003'; '005'; '006';'007'];
expt(5).nrun = size(expt(5).runs,1);
expt(5).frame_rate = 30;
expt(5).folder = 'two-photon imaging';
expt(5).catch = 1;
expt(5).dirtuning = '009';
expt(5).dirtuning_time = '1147';
expt(5).rettuning = {'008';'1143'};
