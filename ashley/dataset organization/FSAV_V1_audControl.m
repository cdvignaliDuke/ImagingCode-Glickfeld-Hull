...
% %% AW71 170116 V1 injection **not enough trials**
% expt(2).SubNum = '671';
% expt(2).mouse = 'AW71';
% expt(2).date = '170116';
% expt(2).img_loc  = {'V1';'L2/3'};
...
% %% AW71 170123 V1 injection **not enough trials**
% expt(2).SubNum = '671';
% expt(2).mouse = 'AW71';
% expt(2).date = '170123';
% expt(2).img_loc  = {'V1';'L2/3'};
% expt(2).img_strct  = {'cells'};
% expt(2).time_mat = ['1130';'1148'];
% expt(2).runs = ['002';'003'];
% expt(2).nrun = size(expt(2).runs,1);
% expt(2).frame_rate = 30;
% expt(2).folder = 'two-photon imaging';
% expt(2).dirtuning = '006';
% expt(2).dirtuning_time = '1217';
% expt(2).rettuning = {'007';'1226'};
% expt(2).motionTestBimodal = 0;
% expt(2).z = 250;
% expt(2).regImgStartFrame = nan;
% expt(2).trial_range = [1:40,60:90];
% expt(2).attentionTask = false;
% expt(2).hasAttention = false;
% expt(2).catch = 0;
% expt(2).catchRew = 0;
...
expt(2).rettuning = {'005';'1147'};
expt(2).motionTestBimodal = 0;
expt(2).z = 246;
expt(2).regImgStartFrame = 26981;
...
expt(4).img_loc  = {'V1';'L2/3'};
expt(4).img_strct  = {'cells'};
expt(4).time_mat = ['0935';'1006'];
expt(4).runs = ['001';'002'];
expt(4).nrun = size(expt(4).runs,1);
expt(4).frame_rate = 30;
expt(4).folder = 'two-photon imaging';
expt(4).dirtuning = '003';
expt(4).dirtuning_time = '1041';
expt(4).rettuning = {'004';'1052'};
expt(4).motionTestBimodal = 0;
expt(4).z = 216;
expt(4).regImgStartFrame = 77013;
expt(4).trial_range = [1:20,100:200];
