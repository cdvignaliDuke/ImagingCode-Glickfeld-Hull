...
expt(3).img_loc  = {'V1';'L2/3'};
expt(3).img_strct  = {'cells'};
expt(3).time_mat = ['1142'; '1158'; '1217'];
expt(3).runs = ['002'; '003'; '004'];
expt(3).nrun = size(expt(3).runs,1);
expt(3).frame_rate = 30;
expt(3).folder = 'two-photon imaging';
expt(3).catch = 0;
expt(3).dirtuning = '006';
expt(3).dirtuning_time = '1239';
expt(3).rettuning = {'005';'1235'};
expt(3).motionTestBimodal = 1;
expt(3).stimOnMs = 100;
expt(3).motionThreshold = 0.03;
...
expt(9).time_mat = ['1047'; '1103'; '1119'];
...
expt(9).dirtuning_time = '1145';
expt(9).rettuning = {'004';'1140'};
...
% expt(10).time_mat = ['1453'; '1509'; '1525'; '1541'];
...
% expt(10).dirtuning_time = '1602';
% expt(10).rettuning = {'005'; '1558'};
...
% expt(10).img_loc  = {'V1';'L2/3'};
% expt(10).img_strct  = {'cells'};
% expt(10).time_mat = ['1617'; '1650'; '1707'];
...
% expt(10).dirtuning_time = '1729';
% expt(10).rettuning = {'006'; '1724'};
% expt(10).motionTestBimodal = 0;
% expt(10).stimOnMs = 200;
...
expt(10).img_loc  = {'V1';'L2/3'};
expt(10).img_strct  = {'cells'};
expt(10).time_mat = ['1113';'1130'];%'1040'; '1057';
expt(10).runs = ['003';'004'];%'001'; '002';
expt(10).nrun = size(expt(10).runs,1);
expt(10).frame_rate = 30;
expt(10).folder = 'two-photon imaging';
expt(10).catch = 1;
...
expt(11).time_mat = ['1346';'1402';'1421';'1437'];%
expt(11).runs = ['006';'007';'008';'009'];% 
expt(11).nrun = size(expt(11).runs,1);
expt(11).frame_rate = 30;
expt(11).folder = 'two-photon imaging';
expt(11).catch = 1;
expt(11).dirtuning = '011';
expt(11).dirtuning_time = '1457';
expt(11).rettuning = {'010';'1453'};
...
% expt(12).time_mat = ['1026'; '1042';'1058'];%'1005'; 
% expt(12).runs = ['002'; '003';'004'];%'001'; 
% expt(12).nrun = size(expt(12).runs,1);
% expt(12).frame_rate = 30;
% expt(12).folder = 'two-photon imaging';
% expt(12).catch = 1;
% expt(12).dirtuning = '006';
% expt(12).dirtuning_time = '1121';
% expt(12).rettuning = {'005';'1116'};
...
% expt(8).img_loc  = {'V1';'L2/3'};
% expt(8).img_strct  = {'cells'};
% expt(8).time_mat = ['0955'; '1011'; '1029'];
% expt(8).runs = ['004'; '005'; '006'];
% expt(8).nrun = size(expt(8).runs,1);
% expt(8).frame_rate = 30;
% expt(8).folder = 'two-photon imaging';
% expt(8).catch = 0;
% expt(8).dirtuning = '008';
% expt(8).dirtuning_time = '1050';
% expt(8).rettuning = {'007';'1046'};
% expt(8).motionTestBimodal = 0;
% expt(8).z = 288;
% expt(8).stimOnMs = 100;
...
expt(12).img_loc  = {'V1';'L2/3'};
expt(12).img_strct  = {'cells'};
expt(12).time_mat = ['1042';'1058';'1115';'1131'];
expt(12).runs = ['001';'002';'003';'005'];
expt(12).nrun = size(expt(12).runs,1);
expt(12).frame_rate = 30;
expt(12).folder = 'two-photon imaging';
expt(12).catch = 1;
expt(12).dirtuning = '006';
expt(12).dirtuning_time = '1147';
expt(12).rettuning = {'007';'1156'};
expt(12).motionTestBimodal = 0;
expt(12).z = 203;
...
expt(13).time_mat = ['1130';'1146';'1202'];
...
expt(13).dirtuning_time = '1231';
expt(13).rettuning = {'007';'1246'};
...
% expt(15).img_loc  = {'V1';'L2/3'};
% expt(15).img_strct  = {'cells'};
% expt(15).time_mat = ['1448';'1504';'1525'];
% expt(15).runs = ['003';'004';'005'];
% expt(15).nrun = size(expt(15).runs,1);
% expt(15).frame_rate = 30;
% expt(15).folder = 'two-photon imaging';
% expt(15).catch = 1;
% expt(15).dirtuning = '006';
% expt(15).dirtuning_time = '1559';
% expt(15).rettuning = {'007';'1613'};
% expt(15).motionTestBimodal = 0;
% expt(15).z = 244;
