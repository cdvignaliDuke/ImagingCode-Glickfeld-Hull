...
cd(fileDirMasks);
load('sbx_aligned_img.mat');
load('sbxaligned_data.mat');
% load('neuropil.mat');
clear npTC data_TC_subNP data_TC
...
% get timecourses
dataTC = stackGetTimeCourses(data_reg, mask_cell_all);
...
save('sbxalignedTimecourses.mat','dataTimecourse')
