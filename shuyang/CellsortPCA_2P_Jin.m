...
%
% Inputs:
%   rt - the array you get from stackGroupProject.
...
%   frames.
%   nPCs - number of principal components to be returned (put this number
%   manully, Jake eyeballed the number of densdrites in tiff and that's the nPCs)
