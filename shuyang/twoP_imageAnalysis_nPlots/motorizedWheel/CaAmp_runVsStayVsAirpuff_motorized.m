...
%         end
        ...
        nevent(c) = min([nevent_stay,nevent_run,nevent_staypuff]);
       % if nevent(c)>0
...
%     
    ...
    saveas(Caevent,[image_analysis_dest '\' days{ii} '_CaAmp_aipuffVsRunVsStay']);
    % save variables
...
%     
    ...
    save([image_analysis_dest sessions{ii} '_isoCaEvent.mat'],'isolated_inx_neurons','spk_iso_stay_neurons','spk_iso_run_neurons',...
        ...
        'ave_dfOvF_btm_staypuff_iso_session','ste_dfOvF_btm_staypuff_iso_session','nevent');
    % else
