...
clear;
sessions = {'190705_img1034','190705_img1034_vermisVI','190706_img1033','190706_img1033_vermisVI'};
days = {'1034-190705_1','1034-190705_2','1033-190706-2102_1','1033-190706-2131_1'};
...
for ii = 1: length(sessions)
   % load data
    ...
    legend(['stationary n=' num2str(nevents_stay)],['running n=' num2str(nevents_run)]);
    ylabel('df/f');
    xlabel('time(s)');
    title(sessions(ii));
