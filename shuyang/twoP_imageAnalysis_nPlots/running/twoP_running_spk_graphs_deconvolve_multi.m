...
sessions = {'190427_img1027','190429_img1021','190429_img1027','190430_img1023',...
    '190505_img1024','190507_img1024','190520_img1021',...
    '190603_img1027','190603_img1025','190607_img1025'}; 
days = {'1027-190427_1','1021-190429_1','1027-190429_1','1023-190430_1',...
    '1024-190505_1','1024-190507_1','1021-190520_1',...
    '1027-190603_1','1025-190603_1','1025-190607_1'};
...
for i = 1: size(sessions,2)
    ...
    if size(frms_runTrig_mat,2)<=1
        ...
        vline(befoRunStay/30,'r'); ylabel('average firing rate'); 
    ...
    if size(frms_runoff_mat,2)<=1
        ...
        vline(befoRunStay/30,'r'); ylabel('speed(cm/s)');xlabel('time(s)');%title([sessions ' running triggered average speed']);
        ylim([-5 20]);
    ...
    save([image_analysis_dest sessions{i},'_spk_deconvolve_threshold' num2str(threshold) '.mat'],...
        'spk_runtrig_mat','speed_runtrig','spk_runoff_mat','speed_runoff','-append');
end
