...
errorbar(x,ave_dfOvF_btm_stay_iso_across_plot,ste_dfOvF_btm_stay_iso_across,'.','LineStyle','-','linewidth', 1.25,'MarkerSize',4); hold on;
errorbar(x,ave_dfOvF_btm_run_iso_across,ste_dfOvF_btm_run_iso_across,'.','LineStyle','-','linewidth', 1.25,'MarkerSize',4); hold on;
...
savefig(['Z:\Analysis\2P_MovingDots_Analysis\across_sessions\' 'across_sessions_CaAmpRunvsStay_dfOvF_derivative_samey.fig']);
