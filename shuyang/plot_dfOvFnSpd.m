...
for ii = 1: length(sessions)
    ...
    ave_dfOvF_behav = [ave_dfOvF_stay,ave_dfOvF_bf,ave_dfOvF_run];
    ste_dfOvF_behav = [ste_dfOvF_stay,ste_dfOvF_bf,ste_dfOvF_run];
    
    x = [1,2,3]; x_plot = repmat(x,size(dfOvF,1),1);
    dfOvF_behavStates = figure;
    errorbar(x_plot',ave_dfOvF_behav',ste_dfOvF_behav'); %bar plot?
