...
for i = 1:length(sessions)
    ...
    for n = 1:size(dfOvF,1)
        ...
        %[hAx,hline1,hline2(n)] = plotyy(time(1:1000),speed(1:1000),time(1:1000),dfOvF_plot(1:1000));
        [hAx,hline1,hline2(n)] = plotyy(time,speed,time,dfOvF_plot);
        set(hline1,'color', 'b'); legend('speed','ROI1','ROI2','ROI3','Location','southeast');
