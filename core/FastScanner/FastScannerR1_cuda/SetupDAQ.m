...
set(fs.DAQ.ai, 'TriggerCondition', 'PositiveEdge')
...
% high upon start. trigger on high to low transition. for estim
fs.DAQ.aoCurrentTriggerValue=0; % VB 12/13/07 already set in IniParameters 
