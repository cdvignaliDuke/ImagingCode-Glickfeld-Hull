...
smdc=length(find(dcrossup<800));
smdc2=length(find(dcrossup<20));
period=(tcrossup(end)-tcrossup(1))/(length(tcrossup)-1-smdc2-(smdc-smdc2)/2);


firstpoint=min(tcrossup(1)-1,10);
bbb=regress(double(xpos(tcrossup(1)-firstpoint:tcrossup(1)+10))',[ones(firstpoint+11,1) (-firstpoint:10)']);
