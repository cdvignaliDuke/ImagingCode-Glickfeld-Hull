...
set(handles.txtMinChannel1,'String',num2str(min(min(fd.img.Ch(1).CDataV2(:)))));
set(handles.txtMaxChannel1,'String',num2str(max(max(fd.img.Ch(1).CDataV2(:)))));
...
% 
set(handles.txtMinChannel2,'String',num2str(min(min(fd.img.Ch(2).CDataV2(:)))));
set(handles.txtMaxChannel2,'String',num2str(max(max(fd.img.Ch(2).CDataV2(:)))));
...
if fd.stats.show
    ...
    set(fd.stats.ax,'ylimmode','manual','ylim', [0 2050]);
