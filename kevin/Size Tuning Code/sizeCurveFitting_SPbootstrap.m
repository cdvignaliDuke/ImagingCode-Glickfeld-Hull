...
if exist(filename, 'file') && ~override
    ...
    x_max = szs(find(sizeMean(:,nCon,nCells)==maxMean,1));
    if isempty(x_max)
        x_max = 15;
    end
    ...
    for iCell = 1:nCells
        ...
        for iCon = 1:nCon
            ...
            x_max = szs(find(sizeMean(:,iCon,iCell)==maxMean,1));
            ...
            if verbose
                ...
                fprintf(['X_max = ' num2str(x_max) '\n'])
                fprintf(['guess 1 = ' num2str(s.fit1.x0(3)) '\nguess 2 = ' num2str([s.fit2.x0(3) s.fit2.x0(6)]) '\n'])
