...
for iexp = 1:nexp
    ...
    load(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_baseResp.mat']))
...
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', 'Adaptation',['randInt_dFoverF_trialLength.pdf']),'-dpdf','-fillpage')
