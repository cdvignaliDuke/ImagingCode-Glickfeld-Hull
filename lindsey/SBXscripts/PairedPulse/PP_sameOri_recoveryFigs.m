...
save(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_PPresp.mat']), 'resp_off', 'resp_off_sub','resp_off_dir', 'resp_off_dir_sub', 'max_dir', 'good_ind')
...
for iCell = 1:length(good_ind)
    ...
    %print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_resp_byInt_Cell' num2str(iC) '.pdf']),'-dpdf','-bestfit')
end
...
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_allDir.pdf']),'-dpdf','-bestfit')
...
suptitle([mouse ' ' date '- ' num2str(length(good_ind)) ' cells']) 
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_maxDir_norm.pdf']),'-dpdf','-bestfit')
...
xlabel('Time (ms)')
suptitle([mouse ' ' date '- ' num2str(length(good_ind)) ' cells']) 
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_scatter.pdf']),'-dpdf','-bestfit')
...
suptitle([mouse ' ' date '- ' num2str(length(good_ind)) ' cells']) 
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_heatmap.pdf']),'-dpdf','-bestfit')
...
xlabel('Time (ms)')
suptitle([mouse ' ' date '- ' num2str(length(good_ind)) ' cells']) 
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_maxDir_scatter.pdf']),'-dpdf','-bestfit')
...
ylim([0 1.5])
suptitle([mouse ' ' date])
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_FDttest.pdf']),'-dpdf','-bestfit')
...
ylim([0 1.5])
suptitle([mouse ' ' date])
print(fullfile('\\CRASH.dhe.duke.edu\data\home\lindsey\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_avgResp_byInt_FD.pdf']),'-dpdf','-bestfit')
