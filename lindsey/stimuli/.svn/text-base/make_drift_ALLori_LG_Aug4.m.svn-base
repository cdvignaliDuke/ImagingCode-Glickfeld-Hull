...
LUM_LO = 1; %.4;
LUM_MEAN = .7565; %figure this out empirically using calibration
...
PWD_visfiles = ['\\Zmey\storlab\users\Lindsey\visual stimuli\cfostraining'];
...
for count = 1:length(ori_vec)
  ...
  file_save0 = [PWD_visfiles,'090804_ALLORI_vid_drift_grat_', ...
