...
LUM_HI = .1; %.95; %set to 0 and 1 for prev version
LUM_LO = 0; %.4;
LUM_MEAN = .075; %figure this out impirically using calibration
...
ori_vec = [0 180]*pi/180; % 0 26 45 58 67.5 74 79 82 84.5 86]*pi/180; %[0 90]*pi/180;
...
%	  count_phase2 = count_phase;
  ...
  file_save0 = [PWD_visfiles,'090804_vid_drift_grat_4dir', ...
