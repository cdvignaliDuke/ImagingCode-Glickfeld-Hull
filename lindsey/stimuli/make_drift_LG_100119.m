...
LUM_HI = .45; %.95; %set to 0 and 1 for prev version
LUM_LO = .45; %.4;
LUM_MEAN = .375; %figure this out impirically using calibration
...
%	  count_phase2 = count_phase;
  ...
  file_save0 = [PWD_visfiles,'100119_vid_drift_squarewavegrat_', ori_txt,'ori_',color,'_',...
