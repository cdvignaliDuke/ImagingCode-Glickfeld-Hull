...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM118\120920\';
...
file_mat = strvcat(...
    '120920_CM118_run1_dec_reg.tif', ...
    '120920_CM118_run2_dec_reg.tif', ...
    '120920_CM118_run3_dec_reg.tif', ...
    '120920_CM118_run4_dec_reg.tif', ...
    '120920_CM118_run5_dec_reg.tif', ...
    '120920_CM118_run6_dec_reg.tif', ...
    '120920_CM118_run7_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120920\CM118_run5\TF2_SF2_ori16_Con1_Nfrpstim240_Ret1_GabSz13_20Sep2012\');
...
RandStim_info.prot(count_prot).StimXpos = [-20*ones(1,64) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-5*ones(1,64) 0]; %y pos 
...
RandStim_info.prot(count_prot).StimYpos = [-5*ones(1,25) 0]; %y pos 
