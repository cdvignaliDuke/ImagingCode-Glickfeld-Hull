...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC43\110815\';
...
file_mat = strvcat(...
    '110815_AC43_run1.tif', ...
    '110815_AC43_run2.tif', ...
    '110815_AC43_run3.tif', ...
    '110815_AC43_run4.tif', ...
    '110815_AC43_run5.tif', ...
    '110815_AC43_run6_dec_reg.tif', ...
    '110815_AC43_run7_dec_reg.tif', ...
    '110815_AC43_run8_dec_reg.tif',...
    '110815_AC43_run9_dec_reg.tif',...
    '110815_AC43_run10_dec_reg.tif',...
    '110815_AC43_run11_dec_reg.tif',...
    '110815_AC43_run12_dec_reg.tif',...
    '110815_AC43_run13_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110815\AC43_run6\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110815\AC43_run7\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110815\AC43_run8\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_15Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110815\AC43_run11\TF7_SF1_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110815\AC43_run12\TF7_SF1_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Aug2011\');
...
RandStim_info.prot(count_prot).TFvec = [repmat([.5 1 2 4 8 15 24],1,5) 0];
...
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,35) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [0*ones(1,35) 0]; %y pos 
...
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,50) 0]; %x pos 
...
if Nprotocols > 3
    count_prot = 4;
RandStim_info.prot(count_prot).userun0 = [13];
RandStim_info.prot(count_prot).userunDR = [1];
...
RandStim_info.prot(count_prot).StimYpos = [0*ones(1,7) 0]; %y pos 
...
if Nprotocols > 4
    count_prot = 5;
RandStim_info.prot(count_prot).userun0 = [12];
RandStim_info.prot(count_prot).userunDR = [1];
