...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y26\110821\';
...
file_mat = strvcat(...
    ...
    '110821_Y26_run5.tif', ...
    '110821_Y26_run6.tif', ...
    '110821_Y26_run7_dec_reg.tif', ...
    '110821_Y26_run8_dec_reg.tif', ...
    '110821_Y26_run9_dec_reg.tif', ...
    '110821_Y26_run10_dec_reg.tif', ...
    '110821_Y26_run11_dec_reg.tif', ...
    '110821_Y26_run12_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run2\TF2_SF1_ori1_Con1_Nfrpstim240_Ret4_GabSz13_21Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run3\TF1_SF1_ori1_Con1_Nfrpstim240_Ret6_GabSz13_21Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run4\TF1_SF1_ori1_Con1_Nfrpstim240_Ret4_GabSz13_21Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run5\TF1_SF1_ori1_Con1_Nfrpstim240_Ret3_GabSz13_21Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run7\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_21Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\Y26_run10\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_21Aug2011\');
...
randvec = [0 0
           ...
           6 1
           6 2
           6 3]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).TFvec = [repmat([1 4],1,4) 0];
RandStim_info.prot(count_prot).SFvec = [0.16*ones(1,8) 0];
RandStim_info.prot(count_prot).pos = [ones(1,9)];
RandStim_info.prot(count_prot).StimXpos = [repmat([-5 5 15 25],1,2) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-10*ones(1,8) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 =9; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,8) 0]*pi/180;
...
RandStim_info.prot(count_prot).SFvec = [0.16*ones(1,6) 0];
RandStim_info.prot(count_prot).pos = [ones(1,7)];
RandStim_info.prot(count_prot).StimXpos = [repmat([-20 0 20],1,2) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,3) -5*ones(1,3) 0]; %y pos 
...
RandStim_info.prot(count_prot).TFvec = [4*ones(1,4) 0];
RandStim_info.prot(count_prot).SFvec = [0.16*ones(1,4) 0];
RandStim_info.prot(count_prot).pos = [ones(1,5)];
RandStim_info.prot(count_prot).StimXpos = [-15 -5 5 15 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-10*ones(1,4) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 =5; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,4) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,4) 0];
RandStim_info.prot(count_prot).Fs1 = 2; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 2; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 10;
RandStim_info.prot(count_prot).Non1 = 10;
