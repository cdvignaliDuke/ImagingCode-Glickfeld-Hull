...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM66\120622\';
...
file_mat = strvcat(...
    '120622_CM66_run1.tif', ...
    '120622_CM66_run2.tif', ...
    '120622_CM66_run3.tif',...
    '120622_CM66_run4.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120622\CM66_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_22Jun2012\');
...
RandStim_info.prot(count_prot).SFvec = [repmat([.32 .08 .02],1,3) 0];
