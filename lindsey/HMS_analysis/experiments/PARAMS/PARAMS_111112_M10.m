...
PWD = 'G:\users\lindsey\analysisLG\active mice\M10\111112\';
...
file_mat = strvcat(...
    '111112_M10_run1_dec_reg.tif', ...
    '111112_M10_run2_dec_reg.tif', ...
    '111112_M10_run3_dec_reg.tif', ...
    '111112_M10_run4_dec_reg.tif', ...
    '111112_M10_run5_dec_reg.tif', ...
    '111112_M10_run6_dec_reg.tif', ...
    '111112_M10_run7_dec_reg.tif', ...
    '111112_M10_run8_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111112\M10_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_12Nov2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111112\M10_run3\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_12Nov2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111112\M10_run5\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_12Nov2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111112\M10_run7\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_12Nov2011\');
...
randvec = [1 1
           ...
           3 2
           3 3
           4 2]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).StimXpos = [-10*ones(1,8) 0]; %x pos 
...
RandStim_info.prot(count_prot).Fs1_orig = 2.667; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 12;
RandStim_info.prot(count_prot).Non1 = 12;RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ton1 = RandStim_info.prot(count_prot).Non1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ntot1 = RandStim_info.prot(count_prot).Fs1 * ...
    (RandStim_info.prot(count_prot).Ton1 + RandStim_info.prot(count_prot).Toff1);
end
