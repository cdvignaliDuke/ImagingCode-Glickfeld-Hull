...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR9\110903\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110903\DR9_run3\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_03Sep2011\');
...
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,7) 0]; %x pos 
