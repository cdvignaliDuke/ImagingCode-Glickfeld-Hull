...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y28\111125\';
...
file_mat = strvcat(...
    '111125_Y28_run1_dec_reg.tif', ...
    '111125_Y28_run2_dec_reg.tif', ...
    '111125_Y28_run3_dec_reg.tif', ...
    '111125_Y28_run4_dec_reg.tif', ...
    '111125_Y28_run5_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111125\Y28_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_25Nov2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111125\Y28_run3\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_25Nov2011\');
...
RandStim_info.prot(count_prot).StimXpos = [15*ones(1,32) 0]; %x pos 
