...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR9\110916\';
...
file_mat = strvcat(...
    ...
    '110916_DR9_run8.tif', ...
    '110916_DR9_run9.tif', ...
    '110916_DR9_run10.tif', ...
    '110916_DR9_run11.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110916\DR9_run8\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_16Sep2011\');
...
count_prot = 1;
RandStim_info.prot(count_prot).userun0 = [9:11];
RandStim_info.prot(count_prot).userunDR = [1];

RandStim_info.prot(count_prot).TFvec = [4*ones(1,7) 0];
RandStim_info.prot(count_prot).SFvec = [.16*ones(1,7) 0];
...
RandStim_info.prot(count_prot).oris = [90*ones(1,50) 0]*pi/180;
