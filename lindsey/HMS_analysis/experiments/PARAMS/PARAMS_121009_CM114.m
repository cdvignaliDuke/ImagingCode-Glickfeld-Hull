...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM114\121009\';
...
file_mat = strvcat(...
    '121009_CM114_run1_dec_reg.tif', ...
    '121009_CM114_run2_dec_reg.tif', ...
    '121009_CM114_run3_dec_reg.tif', ...
    '121009_CM114_run4_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121009\CM114_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_09Oct2012\',...
                    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121009\CM114_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_09Oct2012\');
...
randvec = [1 1
           1 2
           2 3
           2 4]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,32) 0]; %x pos 
