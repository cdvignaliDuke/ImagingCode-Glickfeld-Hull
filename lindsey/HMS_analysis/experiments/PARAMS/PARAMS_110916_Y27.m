...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y27\110916\';
...
file_mat = strvcat(...
    '110916_Y27_run1_dec_reg.tif', ...
    '110916_Y27_run2_dec_reg.tif', ...
    '110916_Y27_run3_dec_reg.tif', ...
    '110916_Y27_run4_dec_reg.tif', ...
    '110916_Y27_run5_dec_reg.tif', ...
    '110916_Y27_run6_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\110916\Y27_run1\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_16Sep2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\110916\Y27_run3\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_16Sep2011\');
...
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,50) 0];RandStim_info.prot(count_prot).Fs1 = 2.667; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 2.667; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 12;
RandStim_info.prot(count_prot).Non1 = 12;
RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
