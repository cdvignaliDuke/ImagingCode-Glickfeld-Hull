...
PWD = 'G:\users\lindsey\analysisLG\active mice\LGN1\111110\';
...
file_mat = strvcat(...
    '111110_LGN1_run1.tif', ...
    '111110_LGN1_run2.tif', ...
    '111110_LGN1_run3_dec_reg.tif', ...
    '111110_LGN1_run4_dec_reg.tif', ...
    '111110_LGN1_run5.tif', ...
    '111110_LGN1_run6.tif', ...
    '111110_LGN1_run7_dec_reg.tif', ...
    '111110_LGN1_run8_dec_reg.tif', ...
    '111110_LGN1_run9.tif', ...
    '111110_LGN1_run10.tif', ...
    '111110_LGN1_run11_dec_reg.tif', ...
    '111110_LGN1_run12_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111110\LGN1_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_10Nov2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111110\LGN1_run4\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_10Nov2011\');
...
count_prot = 1;
RandStim_info.prot(count_prot).userun0 = [11];
RandStim_info.prot(count_prot).userunDR = [1];

RandStim_info.prot(count_prot).TFvec = [repmat([1 4 15],1,3) 0];
RandStim_info.prot(count_prot).SFvec = [.16*ones(1,3) .08*ones(1,3) .04*ones(1,3) 0];
...
RandStim_info.prot(count_prot).SFvec = [.08*ones(1,8) 0];
RandStim_info.prot(count_prot).pos = [ones(1,9)];
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,8) 0]; %x pos 
