...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y11\110520\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110520\Y11_run2\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_20May2011\',...
...
RandStim_info.prot(count_prot).SFvec = [repmat([0.32 0.16 0.08 0.04 0.02],1,5) 0];
RandStim_info.prot(count_prot).pos = [ones(1,26)];
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,25) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [14*ones(1,25) 0]; %y pos 
