...
PWD = 'G:\users\lindsey\analysisLG\active mice\LGN1\111028\';
...
file_mat = strvcat(...
    '111028_LGN1_run1.tif', ...
    '111028_LGN1_run2.tif', ...
    '111028_LGN1_run3.tif', ...
    '111028_LGN1_run4.tif', ...
    '111028_LGN1_run5.tif', ...
    '111028_LGN1_run6.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111028\LGN1_run2\TF3_SF2_ori1_Con1_Nfrpstim240_Ret1_GabSz20_28Oct2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111028\LGN1_run6\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Oct2011\');
...
RandStim_info.prot(count_prot).TFvec = [repmat([1 4 15],1,2) 0];
RandStim_info.prot(count_prot).SFvec = [.16*ones(1,3) .04*ones(1,3) 0];
RandStim_info.prot(count_prot).pos = [ones(1,7)];
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,6) 0]; %x pos 
