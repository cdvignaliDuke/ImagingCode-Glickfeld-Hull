...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM114\121004\';
PWD_EEG = 'G:\users\lindsey\dataLG\2025\110210\LG25\';
...
file_mat = strvcat(...
    '121004_CM114_run1_dec_reg.tif', ...
    '121004_CM114_run2_dec_reg.tif', ...
    '121004_CM114_run3_dec_reg.tif', ...
    '121004_CM114_run4_dec_reg.tif', ...
    '121004_CM114_run5_dec_reg.tif', ...
    '121004_CM114_run6_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121004\CM114_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_04Oct2012\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121004\CM114_run3\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_04Oct2012\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121004\CM114_run5\TF2_SF2_ori1_Con7_Nfrpstim240_Ret1_GabSz20_04Oct2012\');
...
randvec = [1 1
           ...
           2 2
           3 1
           3 2]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).StimXpos = [-30*ones(1,25) 0]; %x pos 
...
RandStim_info.prot(count_prot).TFvec = [2*ones(1,16) 8*ones(1,16) 0];
RandStim_info.prot(count_prot).SFvec = [repmat([.16*ones(1,8) .04*ones(1,8)],1,2) 0];
RandStim_info.prot(count_prot).pos = [ones(1,33)];
RandStim_info.prot(count_prot).StimXpos = [-30*ones(1,32) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,32) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 33; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [repmat([0:45:315], 1, 4) 0]*pi/180;
...
RandStim_info.prot(count_prot).userunDR = [1];
RandStim_info.prot(count_prot).TFvec = [2*ones(1,14) 8*ones(1,14) 0];
RandStim_info.prot(count_prot).SFvec = [repmat([.16*ones(1,7) .04*ones(1,7)],1,2) 0];
RandStim_info.prot(count_prot).pos = [ones(1,29)];
RandStim_info.prot(count_prot).StimXpos = [-30*ones(1,28) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,28) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 29; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,28) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [repmat([0.025 0.05 0.1 0.2 0.4 0.8 1.0], 1, 4) 0];
RandStim_info.prot(count_prot).Fs1 = 2.667; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 2.667; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 12;
RandStim_info.prot(count_prot).Non1 = 12;
...
if Nprotocols > 3
    count_prot = 4;
RandStim_info.prot(count_prot).userun0 = [9:10];
RandStim_info.prot(count_prot).userunDR = [1];

RandStim_info.prot(count_prot).TFvec = [repmat([1 2 4 8 15],1,5) 0];
RandStim_info.prot(count_prot).SFvec = [.32*ones(1,5) .16*ones(1,5) .08*ones(1,5) .04*ones(1,5) .02*ones(1,5) 0];
RandStim_info.prot(count_prot).pos = [ones(1,26)];
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,25) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,25) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 26; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,25) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,25) 0];
RandStim_info.prot(count_prot).Fs1 = 10; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 10; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 40;
RandStim_info.prot(count_prot).Non1 = 10;RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ton1 = RandStim_info.prot(count_prot).Non1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ntot1 = RandStim_info.prot(count_prot).Fs1 * ...
    (RandStim_info.prot(count_prot).Ton1 + RandStim_info.prot(count_prot).Toff1);
end
...
if Nprotocols > 4
    count_prot = 5;
    RandStim_info.prot(count_prot).userun0 = [11 16 17];
    RandStim_info.prot(count_prot).userunDR = [1];

RandStim_info.prot(count_prot).TFvec = [1 1 15 0];
RandStim_info.prot(count_prot).SFvec = [.32 .02 .02 0];
RandStim_info.prot(count_prot).pos = [ones(1,4)];
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,3) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,3) 0]; %y pos 
...
if Nprotocols > 5
    count_prot = 6;
    RandStim_info.prot(count_prot).userun0 = [12:15];
    RandStim_info.prot(count_prot).userunDR = [1];
...
if Nprotocols > 6
    count_prot = 7;
    RandStim_info.prot(count_prot).userun0 = [10:14];
    RandStim_info.prot(count_prot).userunDR = [1];
...
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,9) 0]; %x pos 
