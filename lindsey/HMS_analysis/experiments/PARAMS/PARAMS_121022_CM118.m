...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM118\121022\';
...
file_mat = strvcat(...
    '121022_CM118_run1_dec_reg.tif', ...
    '121022_CM118_run2_dec_reg.tif', ...
    '121022_CM118_run3_dec_reg.tif', ...
    '121022_CM118_run4_dec_reg.tif', ...
    '121022_CM118_run5_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121022\CM118_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_22Oct2012\');
...
randvec = [1 1
           ...
           1 3
           1 4
           1 5]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).StimYpos = [-20*ones(1,25) 0]; %y pos 
