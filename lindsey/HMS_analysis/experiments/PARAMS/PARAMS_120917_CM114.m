...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM114\120917\';
...
file_mat = strvcat(...
    '120917_CM114_run1_dec_reg.tif', ...
    '120917_CM114_run2_dec_reg.tif', ...
    '120917_CM114_run3_dec_reg.tif', ...
    '120917_CM114_run4_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120917\CM114_run1\TF2_SF2_ori16_Con1_Nfrpstim240_Ret1_GabSz13_17Sep2012\');
...
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,64) 0]; %y pos 
