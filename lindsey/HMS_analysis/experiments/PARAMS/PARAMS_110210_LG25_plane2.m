plane_number = 2; %1 => 1st plane (or volume) imaged that day

PWD = 'G:\users\lindsey\analysisLG\2010\LG25\110210\plane2\';
...
file_mat = strvcat(...
    '110210_LG25_plane2_run1_reg.tif', ...
    '110210_LG25_plane2_run2_reg.tif', ...
    '110210_LG25_plane2_run3_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_plane2_run1.tif';
file_mask = 'AVG_110210_LG25_run2.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110210\TF1_SF8_ori1_Con1_Nfrpstim240_Ret1_GabSz13_10Feb2011\', ...
                    'G:\users\lindsey\dataLG\vis_stim_protocols\110210\TF8_SF1_ori1_Con1_Nfrpstim240_Ret1_GabSz13_10Feb2011\', ...
                    'G:\users\lindsey\dataLG\vis_stim_protocols\110210\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz13_10Feb2011\');
...
RandStim_info.prot(count_prot).SFvec = [0 .01 .02 .04 .08 .16 .32 .64 0];
...
if Nprotocols > 1
    ...
    RandStim_info.prot(count_prot).SFvec = [0.32*ones(1,8) 0];
    RandStim_info.prot(count_prot).pos = [ones(1,9)];
    RandStim_info.prot(count_prot).StimXpos = [-25*ones(1,8) 0]; %x pos for positions 1-9
    RandStim_info.prot(count_prot).StimYpos = [0*ones(1,8) 0]; %y pos for positions 1-9
    RandStim_info.prot(count_prot).Nstimtypes0000 = 9; %2 or 6 or 8
    RandStim_info.prot(count_prot).oris = [0*ones(1,8) 0]*pi/180;
