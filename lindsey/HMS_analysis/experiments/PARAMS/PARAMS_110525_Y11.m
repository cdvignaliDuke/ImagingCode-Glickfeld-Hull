...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y11\110525\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110525\Y11_run1\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_16May2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110525\Y11_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_20May2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110525\Y11_run4\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_20May2011\');
...
RandStim_info.prot(count_prot).TFvec = [1*ones(1,5) 2*ones(1,5) 4*ones(1,5) 8*ones(1,5) 15*ones(1,5) 0];
RandStim_info.prot(count_prot).SFvec = [repmat([.32 .16 .08 .04 .02],1,5) 0];
...
RandStim_info.prot(count_prot).Noff1 = 30;
...
RandStim_info.prot(count_prot).StimXpos = [20*ones(1,9) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-14*ones(1,9) 0]; %y pos 
...
RandStim_info.prot(count_prot).TFvec = [0.5*ones(1,5) 1*ones(1,5) 2*ones(1,5) 4*ones(1,5) 8*ones(1,5) 15*ones(1,5) 24*ones(1,5) 0];
RandStim_info.prot(count_prot).SFvec = [repmat([0.02 0.04 0.08 0.16 0.32],1,7) 0];
RandStim_info.prot(count_prot).pos = [ones(1,36)];
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,35) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [14*ones(1,35) 0]; %y pos 
