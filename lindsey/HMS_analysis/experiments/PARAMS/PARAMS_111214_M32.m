...
PWD = 'G:\users\lindsey\analysisLG\active mice\M32\111214\';
...
file_mat = strvcat(...
    ...
    '111214_M32_run8.tif', ...
    '111214_M32_run9.tif', ...
    '111214_M32_run10.tif', ...
    '111214_M32_run11.tif', ...
    '111214_M32_run12.tif', ...
    '111214_M32_run13.tif', ...
    '111214_M32_run14.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111213\M32_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_13Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111213\M32_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_13Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111214\M32_run3\TF1_SF1_ori1_Con1_Nfrpstim240_Ret3_GabSz20_14Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111214\M32_run3\TF1_SF1_ori1_Con1_Nfrpstim240_Ret3_GabSz20_14Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111214\M32_run3\TF1_SF1_ori1_Con1_Nfrpstim240_Ret3_GabSz20_14Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111214\M32_run3\TF1_SF1_ori1_Con1_Nfrpstim240_Ret3_GabSz20_14Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111214\M32_run10\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_14Dec2011\');
...
randvec = [1 1
           ...
           7 3
           7 4
           7 5]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).Fs1 = 2; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 2; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 8;
RandStim_info.prot(count_prot).Non1 = 2;
RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ton1 = RandStim_info.prot(count_prot).Non1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ntot1 = RandStim_info.prot(count_prot).Fs1 * ...
...
RandStim_info.prot(count_prot).TFvec = [2*ones(1,3) 0];
RandStim_info.prot(count_prot).SFvec = [.04*ones(1,3) 0];
RandStim_info.prot(count_prot).pos = [ones(1,4)];
RandStim_info.prot(count_prot).StimXpos = [-30 0 30 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [0*ones(1,3) 0]; %y pos 
...
if Nprotocols > 5
    count_prot = 6;
    RandStim_info.prot(count_prot).userun0 = [6:9];
    RandStim_info.prot(count_prot).userunDR = [1];
