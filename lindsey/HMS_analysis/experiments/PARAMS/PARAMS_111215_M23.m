...
PWD = 'G:\users\lindsey\analysisLG\active mice\M23\111215\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111215\M23_run4\TF3_SF3_ori3_Con3_Nfrpstim240_Ret1_GabSz20_15Dec2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111215\M23_run3\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_14Dec2011\');
...
RandStim_info.prot(count_prot).StimXpos = [10*ones(1,3) 0]; %x pos 
...
if Nprotocols > 1
    count_prot = 2;
RandStim_info.prot(count_prot).userun0 = [3:6];
RandStim_info.prot(count_prot).userunDR = [1];
