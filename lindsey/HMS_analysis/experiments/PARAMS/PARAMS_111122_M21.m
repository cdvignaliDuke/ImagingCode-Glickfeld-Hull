...
PWD = 'G:\users\lindsey\analysisLG\active mice\M21\111122\';
...
file_mat = strvcat(...
    '111122_M21_run1_dec_reg.tif', ...
    '111122_M21_run2_reg.tif', ...
    '111122_M21_run3_max_reg.tif', ...
    '111122_M21_run4_max_reg.tif', ...
    '111122_M21_run5_max_reg.tif', ...
    '111122_M21_run6_max_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111122\M21_run1\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_22Nov2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111122\M21_run2\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_22Nov2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111122\M21_run3\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_22Nov2011\');
...
randvec = [1 1
           ...
           3 2
           3 3
           3 4]; %directory #, randnum (within that directory)
...
RandStim_info.prot(count_prot).StimYpos = [-20*ones(1,8) 0]; %y pos 
...
RandStim_info.prot(count_prot).Noff1 = 144;
RandStim_info.prot(count_prot).Non1 = 144;
RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ton1 = RandStim_info.prot(count_prot).Non1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ntot1 = RandStim_info.prot(count_prot).Fs1 * ...
