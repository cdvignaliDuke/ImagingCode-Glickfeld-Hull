...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y13\110511\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110511\Y13_run2\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_11May2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110511\Y13_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_11May2011\');
...
RandStim_info.prot(count_prot).TFvec = [repmat([1 4 15],1,3)];
RandStim_info.prot(count_prot).SFvec = [0.32*ones(1,3) 0.08*ones(1,3) 0.02*ones(1,3)];
RandStim_info.prot(count_prot).pos = [ones(1,9)];
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,9)]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-14*ones(1,9)]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 9; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [0*ones(1,9)]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,9)];
...
RandStim_info.prot(count_prot).oris = [0*ones(1,9) 0]*pi/180;
