...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR9\110922\';
...
file_mat = strvcat(...
    '110922_DR9_run1_dec_reg.tif', ...
    '110922_DR9_run2_dec_reg.tif', ...
    '110922_DR9_run3_dec_reg.tif', ...
    '110922_DR9_run4_dec_reg.tif', ...
    '110922_DR9_run5_dec_reg.tif', ...
    '110922_DR9_run6_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\110922\DR9_run1\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_22Sep2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\110922\DR9_run5\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_22Sep2011\');
...
RandStim_info.prot(count_prot).StimXpos = [5*ones(1,50) 0]; %x pos 
...
RandStim_info.prot(count_prot).SFvec = [.16*ones(1,8) 0];
