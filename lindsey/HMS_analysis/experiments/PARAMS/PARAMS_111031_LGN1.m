...
PWD = 'G:\users\lindsey\analysisLG\active mice\LGN1\111031\';
...
file_mat = strvcat(...
    '111031_LGN1_run1.tif', ...
    '111031_LGN1_run2.tif', ...
    '111031_LGN1_run3.tif', ...
    '111031_LGN1_run4.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111031\LGN1_run1\TF2_SF2_ori1_Con1_Nfrpstim240_Ret1_GabSz20_31Oct2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111031\LGN1_run6\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_15Oct2011\');
...
RandStim_info.prot(count_prot).TFvec = [repmat([2 15],1,2) 0];
RandStim_info.prot(count_prot).SFvec = [.16*ones(1,2) .04*ones(1,2) 0];
RandStim_info.prot(count_prot).pos = [ones(1,5)];
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,4) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [0*ones(1,4) 0]; %y pos 
