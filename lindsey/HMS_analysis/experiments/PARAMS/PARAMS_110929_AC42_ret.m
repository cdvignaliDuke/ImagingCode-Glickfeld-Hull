...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC42\110929\';
...
file_mat = strvcat(...
    '110929_AC42_run1.tif', ...
    '110929_AC42_run2.tif', ...
    '110929_AC42_run3.tif', ...
    '110929_AC42_run4.tif', ...
    '110929_AC42_run5.tif', ...
    '110929_AC42_run6.tif', ...
    '110929_AC42_run7.tif', ...
    '110929_AC42_run8.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110929\AC42_run1\TF1_SF1_ori1_Con1_Nfrpstim240_Ret6_GabSz13_29Sep2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110929\AC42_run6\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_29Sep2011\');
...
RandStim_info.prot(count_prot).TFvec = [2*ones(1,6)];
RandStim_info.prot(count_prot).SFvec = [.04*ones(1,6)];
RandStim_info.prot(count_prot).pos = [ones(1,6)];
RandStim_info.prot(count_prot).StimXpos = [-30 -15 0 15 30 45]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,6) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 6; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,6)]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,6)];
...
RandStim_info.prot(count_prot).StimXpos = [-5*ones(1,7) 0]; %x pos 
