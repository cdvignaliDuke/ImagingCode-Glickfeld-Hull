...
PWD = 'G:\users\lindsey\analysisLG\active mice\X28\110511\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110511\X28_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_11May2011',...
...
RandStim_info.prot(count_prot).TFvec = [1*ones(1,3) 4*ones(1,3) 15*ones(1,3)];
RandStim_info.prot(count_prot).SFvec = [repmat([.02 .08 .32],1,3)];
RandStim_info.prot(count_prot).pos = [ones(1,10)];
RandStim_info.prot(count_prot).StimXpos = [36*ones(1,9) 0]; %x pos 
