...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC44\110811\';
...
file_mat = strvcat(...
    '110811_AC44_run1_dec_reg.tif', ...
    '110811_AC44_run2_plane1_reg.tif', ...
    '110811_AC44_run2_plane2_reg.tif', ...
    '110811_AC44_run2_plane3_reg.tif', ...
    '110811_AC44_run2_plane4_reg.tif', ...
    '110811_AC44_run2_plane5_reg.tif', ...
    '110811_AC44_run2_plane6_reg.tif', ...
    '110811_AC44_run2_plane7_reg.tif', ...
    '110811_AC44_run2_plane8_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110811\AC44_run1\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_11Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110811\AC44_run1\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_11Aug2011\');
...
if Nprotocols > 1
    count_prot = 2;
RandStim_info.prot(count_prot).userun0 = [9];
RandStim_info.prot(count_prot).userunDR = [1];
