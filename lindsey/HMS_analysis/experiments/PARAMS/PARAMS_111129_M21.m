...
PWD = 'G:\users\lindsey\analysisLG\active mice\M21\111129\';
...
file_mat = strvcat(...
    '111129_M21_run1_dec_reg.tif', ...
    '111129_M21_run2_dec_reg.tif', ...
    '111129_M21_run3_dec_reg.tif', ...
    '111129_M21_run4_dec_reg.tif', ...
    '111129_M21_run5_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\111129\M21_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_29Nov2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\111129\M21_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_29Nov2011\');
...
RandStim_info.prot(count_prot).StimXpos = [-30*ones(1,50) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-20*ones(1,50) 0]; %y pos 
