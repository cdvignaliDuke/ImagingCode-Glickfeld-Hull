...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR7\110425\';
...
file_mat = strvcat(...
    '110425_DR7_run1_dec_reg.tif', ...
    '110425_DR7_run2_dec_reg.tif', ...
    '110425_DR7_run3_dec_reg.tif', ...
    '110425_DR7_run4_dec_reg.tif', ...
    '110425_DR7_run5_dec_reg.tif', ...
    '110425_DR7_run6_dec_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\110425\DR7_run1\TF1_SF1_ori8_Con1_Nfrpstim240_Ret1_GabSz20_25Apr2011\');
...
RandStim_info.prot(count_prot).TFvec = [8*ones(1,8) 0];
...
RandStim_info.prot(count_prot).TFvec = [0.5 2 4 8 15 24 0.5 2 4 8 15 24 0.5 2 4 8 15 24 0.5 2 4 8 15 24 0.5 2 4 8 15 24 0.5 2 4 8 15 24 0];
RandStim_info.prot(count_prot).SFvec = [0.01 0.01 0.01 0.01 0.01 0.01 0.02 0.02 0.02 0.02 0.02 0.02 0.04 0.04 0.04 0.04 0.04 0.04 0.08 0.08 0.08 0.08 0.08 0.08 0.16 0.16 0.16 0.16 0.16 0.16 0.32 0.32 0.32 0.32 0.32 0.32 0];
RandStim_info.prot(count_prot).pos = [ones(1,37)];
RandStim_info.prot(count_prot).StimXpos = [-30*ones(1,36) 0]; %x pos 
