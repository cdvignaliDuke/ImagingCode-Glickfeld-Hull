...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC36\110709\';
...
file_mat = strvcat(...
    '110709_AC36_run1.tif', ...
    '110709_AC36_run2.tif', ...
    '110709_AC36_run3.tif', ...
    '110709_AC36_run4.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110709\AC36_run3\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_09Jul2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110614\DR8_run4\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_14Jun2011\');
...
RandStim_info.prot(count_prot).StimXpos = [-35*ones(1,7) 0]; %x pos 
...
RandStim_info.prot(count_prot).StimXpos = [10*ones(1,9) 0]; %x pos 
...
RandStim_info.prot(count_prot).Noff1 = 20;
RandStim_info.prot(count_prot).Non1 = 20;
RandStim_info.prot(count_prot).Toff1 = RandStim_info.prot(count_prot).Noff1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ton1 = RandStim_info.prot(count_prot).Non1/RandStim_info.prot(count_prot).Fs1; %s
RandStim_info.prot(count_prot).Ntot1 = RandStim_info.prot(count_prot).Fs1 * ...
    (RandStim_info.prot(count_prot).Ton1 + RandStim_info.prot(count_prot).Toff1);
