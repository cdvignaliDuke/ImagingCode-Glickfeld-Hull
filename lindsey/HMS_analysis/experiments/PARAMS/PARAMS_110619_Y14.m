...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y14\110619\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110619\Y14_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_19Jun2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110619\Y14_run5\TF1_SF1_ori1_Con6_Nfrpstim240_Ret1_GabSz20_19Jun2011\');
...
RandStim_info.prot(count_prot).TFvec = [2*ones(1,6) 0];
...
RandStim_info.prot(count_prot).oris = [90*ones(1,6) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [0.05 0.1 0.2 0.4 0.8 1 0];
RandStim_info.prot(count_prot).Fs1 = 2; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 2; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 10;
RandStim_info.prot(count_prot).Non1 = 10;
