...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC42\111002\';
...
file_mat = strvcat(...
    '111002_AC42_run1_dec_reg.tif', ...
    '111002_AC42_run2_dec_reg.tif', ...
    '111002_AC42_run3_dec_reg.tif', ...
    '111002_AC42_run4_dec_reg.tif', ...
    '111002_AC42_run5_dec_reg.tif', ...
    '111002_AC42_run6_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111002\AC42_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_02Oct2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111002\AC42_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_02Oct2011\');
...
RandStim_info.prot(count_prot).StimXpos = [-5*ones(1,32) 0]; %x pos 
