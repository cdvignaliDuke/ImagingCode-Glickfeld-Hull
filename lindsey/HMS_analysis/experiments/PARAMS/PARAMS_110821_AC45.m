...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC45\110821\';
...
file_mat = strvcat(...
    '110821_AC45_run1.tif', ...
    '110821_AC45_run2.tif', ...
    '110821_AC45_run3.tif', ...
    '110821_AC45_run4.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110821\AC45_run1\TF1_SF1_ori1_Con1_Nfrpstim240_Ret6_GabSz13_21Aug2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\AC45_run2\TF1_SF1_ori1_Con1_Nfrpstim240_Ret6_GabSz13_21Aug2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110821\AC45_run3\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_21Aug2011\');
...
RandStim_info.prot(count_prot).SFvec = [0.16*ones(1,6) 0];
RandStim_info.prot(count_prot).pos = [ones(1,7)];
RandStim_info.prot(count_prot).StimXpos = [-20 -10 0 10 20 30 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-5*ones(1,6) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 =7; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,7) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,7) 0];
RandStim_info.prot(count_prot).Fs1 = 2; %acq rate of imaging Hz %downsampled if applicable
...
RandStim_info.prot(count_prot).TFvec = [4*ones(1,7) 0];
RandStim_info.prot(count_prot).SFvec = [0.16*ones(1,7) 0];
