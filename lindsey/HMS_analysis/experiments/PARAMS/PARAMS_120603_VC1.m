...
PWD = 'G:\users\lindsey\analysisLG\active mice\VC1\120603\';
...
file_mat = strvcat(...
    '120603_VC1_run1_dec_reg.tif', ...
    '120603_VC1_run2_dec_reg.tif', ...
    '120603_VC1_run3_dec_reg.tif', ...
    '120603_VC1_run4_dec_reg.tif', ...
    '120603_VC1_run5_dec_reg.tif', ...
    '120603_VC1_run6_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120603\VC1_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_03Jun2012\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120603\VC1_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_03Jun2012\');
...
RandStim_info.prot(count_prot).StimXpos = [5*ones(1,25) 0]; %x pos 
...
RandStim_info.prot(count_prot).Fs1 = 1; %acq rate of imaging Hz %downsampled if applicable
RandStim_info.prot(count_prot).Fs1_orig = 1; %acq rate of imaging Hz; ignore unless you have eeg
RandStim_info.prot(count_prot).Noff1 = 5;
RandStim_info.prot(count_prot).Non1 = 5;
...
if Nprotocols > 1
    count_prot = 2;
RandStim_info.prot(count_prot).userun0 = [4:6];
RandStim_info.prot(count_prot).userunDR = [1];

RandStim_info.prot(count_prot).TFvec = [repmat([1 2 4 8 15],1,5) 0];
RandStim_info.prot(count_prot).SFvec = [.32*ones(1,5) .16*ones(1,5) .08*ones(1,5) .04*ones(1,5) .02*ones(1,5) 0];
RandStim_info.prot(count_prot).pos = [ones(1,26)];
RandStim_info.prot(count_prot).StimXpos = [20*ones(1,25) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,25) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 26; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,25) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [.8*ones(1,25) 0];
