...
PWD = 'G:\users\lindsey\analysisLG\active mice\W2\110704\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110704\W2_run5\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz13_04Jul2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110630\W2_run7\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_30Jun2011\');
...
RandStim_info.prot(count_prot).StimXpos = [-35*ones(1,9) 0]; %x pos 
...
RandStim_info.prot(count_prot).StimXpos = [-40*ones(1,7) 0]; %x pos 
