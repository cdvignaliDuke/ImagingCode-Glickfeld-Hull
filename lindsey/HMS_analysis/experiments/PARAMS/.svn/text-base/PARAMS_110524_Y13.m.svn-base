...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y13\110524\';
...
file_mat = strvcat(...
    '110524_Y13_run1_reg.tif', ...
    '110524_Y13_run2_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110524\Y13_run1\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz13_24May2011\',...
...
RandStim_info.prot(count_prot).TFvec = [15*ones(1,3) 4*ones(1,3) 1*ones(1,3) 0];
