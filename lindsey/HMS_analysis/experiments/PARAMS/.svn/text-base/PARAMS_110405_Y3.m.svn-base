...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y3\110405\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110405\TF8_SF8_ori8_Con8_Nfrpstim240_Ret1_GabSz20_05Apr2011\', ...
...
RandStim_info.prot(count_prot).StimXpos = [0*ones(1,8) 0]; %x pos 
