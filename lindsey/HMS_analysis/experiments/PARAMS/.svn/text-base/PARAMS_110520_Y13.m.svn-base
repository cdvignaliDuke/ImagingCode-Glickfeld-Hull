...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y13\110520\';
...
file_mat = strvcat(...
    '110520_Y13_run2.tif', ...
    '110520_Y13_run3.tif',...
    '110520_Y13_run3_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110520\Y13_run2\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_19May2011\',...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110520\Y13_run3\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz13_20May2011\');
...
RandStim_info.prot(count_prot).StimYpos = [-7*ones(1,9) 0]; %y pos 
