...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR4\110707\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110707\DR4_run1\TF2_SF3_ori4_Con1_Nfrpstim240_Ret1_GabSz13_07Jul2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110706\Y14_run4\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_06Jul2011\', ...
    'G:\users\lindsey\dataLG\vis_stim_protocols\110706\epi\110706\DR8_run4\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_06Jul2011\');
...
RandStim_info.prot(count_prot).TFvec = [2*ones(1,4) 8*ones(1,4) 2*ones(1,4) 8*ones(1,4) 2*ones(1,4) 8*ones(1,4) 0];
RandStim_info.prot(count_prot).SFvec = [0.04*ones(1,8) 0.08*ones(1,8) 0.16*ones(1,8) 0];
RandStim_info.prot(count_prot).pos = [ones(1,25)];
RandStim_info.prot(count_prot).StimXpos = [-45*ones(1,24) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-10*ones(1,24) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 10; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [repmat([0 45 90 135],1,6) 0]*pi/180;
...
RandStim_info.prot(count_prot).StimXpos = [-15*ones(1,9) 0]; %x pos 
