...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y13\110508\';
...
file_mat = strvcat(...
    '110508_Y13_run1_dec_reg.tif', ...
    '110508_Y13_run2_dec_reg.tif');
...
RandStim_info.prot(count_prot).TFvec = [repmat([.5 2 4 8 15 24],1,6) 0];
RandStim_info.prot(count_prot).SFvec = [0.64*ones(1,6) 0.32*ones(1,6) 0.16*ones(1,6) 0.08*ones(1,6) 0.04*ones(1,6) 0.02*ones(1,6) 0];
