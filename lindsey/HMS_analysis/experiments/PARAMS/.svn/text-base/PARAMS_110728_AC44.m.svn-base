...
PWD = 'G:\users\lindsey\analysisLG\active mice\AC44\110728\';
...
file_mat = strvcat(...
    '110728_AC44_run1.tif', ...
    '110728_AC44_run2.tif', ...
    '110728_AC44_run3.tif', ...
    '110728_AC44_run4.tif', ...
    '110728_AC44_run5.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110728\AC44_run3\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_28Jul2011\');
...
RandStim_info.prot(count_prot).SFvec = [0.32*ones(1,7) 0.16*ones(1,7) 0.08*ones(1,7) 0.04*ones(1,7) 0.02*ones(1,7) 0];
RandStim_info.prot(count_prot).pos = [ones(1,36)];
RandStim_info.prot(count_prot).StimXpos = [25*ones(1,35) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-10*ones(1,35) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 =36; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [90*ones(1,35) 0]*pi/180;
RandStim_info.prot(count_prot).contrastvec = [0.8*ones(1,35) 0];
