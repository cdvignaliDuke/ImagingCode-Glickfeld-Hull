...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y1\110413\';
...
file_mat = strvcat(...
    '110413_Y1_run1_dec_reg.tif', ...
    '110324_LG26_run5_dec_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110413\Y1_run1\TF8_SF8_ori8_Con8_Nfrpstim240_Ret1_GabSz13_12Apr2011');
...
RandStim_info.prot(count_prot).pos = [ones(1,8) 0];
RandStim_info.prot(count_prot).StimXpos = [5*ones(1,8) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-15*ones(1,8) 0]; %y pos 
