...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR8\110614\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110614\DR8_run2\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_14Jun2011\', ...
...
RandStim_info.prot(count_prot).StimXpos = [10*ones(1,35) 0]; %x pos 
