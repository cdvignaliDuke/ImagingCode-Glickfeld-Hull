...
file_mat = strvcat(...
    '110215_LG27_AL_run1_reg.tif', ...
    '110215_LG27_AL_run2_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110215\TF1_SF8_ori1_Con1_Nfrpstim240_Ret1_GabSz13_15Feb2011\', ...
