...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y25\111005\';
...
file_mat = strvcat(...
    '111005_Y25_run1_dec_reg.tif', ...
    '111005_Y25_run2_dec_reg.tif', ...
    '111005_Y25_run3_dec_reg.tif', ...
    '111005_Y25_run4_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111005\Y25_run1\TF5_SF5_ori2_Con1_Nfrpstim240_Ret1_GabSz20_05Oct2011\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\111005\Y25_run8\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_04Oct2011\');
...
if Nprotocols > 1
    count_prot = 2;
RandStim_info.prot(count_prot).userun0 = [8:11];
RandStim_info.prot(count_prot).userunDR = [1];
