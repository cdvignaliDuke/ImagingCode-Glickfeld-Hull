...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM118\121011\';
...
file_mat = strvcat(...
    '121011_CM118_run1.tif', ...
    '121011_CM118_run2.tif', ...
    '121011_CM118_run3.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\121011\CM118_run2\TF3_SF3_ori1_Con1_Nfrpstim240_Ret1_GabSz20_11Oct2012\');
...
RandStim_info.prot(count_prot).StimYpos = [-20*ones(1,9) 0]; %y pos 
