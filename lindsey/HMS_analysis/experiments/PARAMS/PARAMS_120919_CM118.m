...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM118\120919\';
...
file_mat = strvcat(...
    '120919_CM118_run1_dec_reg.tif', ...
    '120919_CM118_run2_dec_reg.tif', ...
    '120919_CM118_run3_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120919\CM118_run1\TF2_SF2_ori16_Con1_Nfrpstim240_Ret1_GabSz13_19Sep2012\');
...
count_prot = 1;
RandStim_info.prot(count_prot).userun0 = [1:3];
...
RandStim_info.prot(count_prot).StimXpos = [-25*ones(1,64) 0]; %x pos 
