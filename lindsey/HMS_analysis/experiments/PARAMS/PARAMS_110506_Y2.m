...
PWD = '\\Zmey\storlab\users\Lindsey\Projects\HVAs\old mice\Y2\110506\';
...
file_mat = strvcat(...
    '110506_Y2_run3_plane3_reg_crop.tif',...
    '110506_Y2_run3_max_reg.tif', ...
    '110506_Y2_run4_max_reg.tif', ...
    '110506_Y2_run5_max_reg.tif');

%file_mat = ['100502_u12_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110506\Y2_run3\TF2_SF3_ori8_Con1_Nfrpstim240_Ret1_GabSz13_06May2011\');
...
RandStim_info.prot(count_prot).TFvec = [repmat([2*ones(1,8) 8*ones(1,8)],1,3) 0];
RandStim_info.prot(count_prot).SFvec = [.04*ones(1,16) .08*ones(1,16) .16*ones(1,16) 0];
