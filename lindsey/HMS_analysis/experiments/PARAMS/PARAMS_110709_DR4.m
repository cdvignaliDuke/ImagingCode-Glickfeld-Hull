...
PWD = 'G:\users\lindsey\analysisLG\active mice\DR4\110709\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110709\DR4_run3\TF7_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_09Jul2011\', ...
...
RandStim_info.prot(count_prot).SFvec = [0.32*ones(1,5) 0.16*ones(1,5) 0.08*ones(1,5) 0.04*ones(1,5) 0.02*ones(1,5) 0];
...
RandStim_info.prot(count_prot).contrastvec = [0.8*ones(1,25) 0];
