...
PWD = 'G:\users\lindsey\analysisLG\active mice\M41\120129\';
...
file_mat = strvcat(...
    '120129_M41_run1_dec_reg.tif', ...
    '120129_M41_run2_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120129\M41_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_29Jan2012\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120129\M41_run1\TF2_SF2_ori8_Con1_Nfrpstim240_Ret1_GabSz20_27Jan2012\');
...
RandStim_info.prot(count_prot).SFvec = [.04*ones(1,8) .16*ones(1,8) .04*ones(1,8) .16*ones(1,8) 0];
RandStim_info.prot(count_prot).pos = [ones(1,33)];
RandStim_info.prot(count_prot).StimXpos = [10*ones(1,32) 0]; %x pos 
RandStim_info.prot(count_prot).StimYpos = [-10*ones(1,32) 0]; %y pos 
RandStim_info.prot(count_prot).Nstimtypes0000 = 33; %2 or 6 or 8
RandStim_info.prot(count_prot).oris = [repmat([0 45 90 135 180 225 270 315],1,4) 0]*pi/180;
