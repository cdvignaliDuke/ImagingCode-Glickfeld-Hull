...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM118\120921\';
...
file_mat = strvcat(...
    '120921_CM118_run1_dec_reg.tif', ...
    '120921_CM118_run2_dec_reg.tif', ...
    '120921_CM118_run3_dec_reg.tif', ...
    '120921_CM118_run4_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120921\CM118_run1\TF2_SF2_ori16_Con1_Nfrpstim240_Ret1_GabSz13_21Sep2012\');
...
randvec = [1 1
           1 2
           1 3
           1 4]; %directory #, randnum (within that directory)

RandStim_info = [];

%%%Repeat entry of these parameters for each stimulus protocol presented (i.e. Nprotocols): 
count_prot = 1;
RandStim_info.prot(count_prot).userun0 = [1:4];
