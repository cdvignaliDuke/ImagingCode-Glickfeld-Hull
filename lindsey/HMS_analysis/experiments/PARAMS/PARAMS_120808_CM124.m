...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM124\120808\';
...
file_mat = strvcat(...
    '120808_CM124_run1_dec_reg.tif', ...
    '120808_CM124_run2_dec_reg.tif', ...
    '120808_CM124_run3_dec_reg.tif', ...
    '120808_CM124_run4_dec_reg.tif');

%file_mat = ['100502_u3912_run3023__ch2_fix_reg.tif'];
file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120808\CM124_run1\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_08Aug2012\');
...
RandStim_info.prot(count_prot).SFvec = [.32*ones(1,5) .16*ones(1,5) .08*ones(1,5) .04*ones(1,5) .02*ones(1,5) 0];
RandStim_info.prot(count_prot).pos = [ones(1,26)];
RandStim_info.prot(count_prot).StimXpos = [-40*ones(1,25) 0]; %x pos 
