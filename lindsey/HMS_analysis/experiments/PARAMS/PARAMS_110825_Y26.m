...
PWD = 'G:\users\lindsey\analysisLG\active mice\Y26\110825\';
...
DIR_rand0 = strvcat('G:\users\lindsey\dataLG\vis_stim_protocols\110825\Y26_run3\TF1_SF1_ori1_Con7_Nfrpstim240_Ret1_GabSz20_25Aug2011\', ...
...
RandStim_info.prot(count_prot).SFvec = [.04*ones(1,7) 0];
...
RandStim_info.prot(count_prot).contrastvec = [.05 .1 .2 .4 .6 .8 1 0];
