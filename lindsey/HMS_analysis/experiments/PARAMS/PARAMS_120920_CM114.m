...
PWD = 'G:\users\lindsey\analysisLG\active mice\CM114\120920\';
...
file_mat = strvcat(...
    '120920_CM114_run1_dec_reg.tif', ...
    '120920_CM114_run2_dec_reg.tif', ...
    '120920_CM114_run3_dec_reg.tif', ...
    '120920_CM114_run4_dec_reg.tif', ...
    '120920_CM114_run5_dec_reg.tif', ...
    '120920_CM114_run6_dec_reg.tif', ...
    '120920_CM114_run7_dec_reg.tif');


file_ch2 = 'AVG_110210_LG25_run1.tif';
file_mask = 'AVG_110210_LG25_run1.tif';

DIR_rand0 = strvcat('\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120920\CM114_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_20Sep2012\',...
    '\\zoloto\bigstorlab\Lindsey\vis_stim_protocols\120920\CM114_run4\TF5_SF5_ori1_Con1_Nfrpstim240_Ret1_GabSz20_20Sep2012\');
...
if Nprotocols > 1
    count_prot = 2;
RandStim_info.prot(count_prot).userun0 = [6:7];
RandStim_info.prot(count_prot).userunDR = [1];
