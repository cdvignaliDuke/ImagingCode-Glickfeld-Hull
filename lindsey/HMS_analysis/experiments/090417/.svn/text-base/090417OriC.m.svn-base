...
pn = 'G:\users\lindsey\analysisLG\090417\OriCRegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\090417\OriC';
...
save(fullfile(analpn,'OriCcellmaskssubset.mat'),'mask_cellsubset');
...
%% cell time courses
load 'g:\users\lindsey\analysisLG\090417\OriCneuronmasks.mat';
