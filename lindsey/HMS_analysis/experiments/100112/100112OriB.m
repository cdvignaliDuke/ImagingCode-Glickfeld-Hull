...
pn = 'G:\users\lindsey\analysisLG\100112\100112OriBRegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\100112\OriB';
...
save(fullfile(analpn,'OriBcellmasks.mat'),'mask_cell');
...
save(fullfile(analpn,'OriBastromasks.mat'),'mask_astro')
...
save(fullfile(analpn,'OriBneuronmasks.mat'),'mask_neuron')
...
figure;
imagesq(imShade(img_green_adapt,mask_GPFneuron>0));
save(fullfile(analpn,'OriBGFPneuronmasks.mat'),'mask_GFPneuron');

%% cell time courses
load 'g:\users\lindsey\analysisLG\100112\OriAneuronmasks.mat';
...
%subset figures
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[4 10 13 14])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[17 27 28])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[43 47 52 53])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[36 55 65 76])));
axis([0 120 -10 90])
...
load 'g:\users\lindsey\analysisLG\100112\OriAGFPneuronmasks.mat';
