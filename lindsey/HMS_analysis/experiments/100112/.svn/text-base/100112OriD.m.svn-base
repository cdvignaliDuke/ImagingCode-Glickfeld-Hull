...
pn = 'G:\users\lindsey\analysisLG\100112\100112OriDRegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\100112\OriD';
...
save(fullfile(analpn,'OriDGFPneuronmasks.mat'),'mask_GFPneuron');
...
%subset figures
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[2 5 14 16])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[22 23 24 29])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[33 39 42])));
axis([0 120 -10 90])
