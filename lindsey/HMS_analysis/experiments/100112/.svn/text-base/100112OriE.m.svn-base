...
pn = 'G:\users\lindsey\analysisLG\100112\100112OriERegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\100112\OriE';
...
save(fullfile(analpn,'OriEcellmasks.mat'),'mask_cell');
...
save(fullfile(analpn,'OriEastromasks.mat'),'mask_astro')
...
save(fullfile(analpn,'OriEneuronmasks.mat'),'mask_neuron')
...
save(fullfile(analpn,'OriEGFPneuronmasks.mat'),'mask_GFPneuron');
...
%subset figures
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[1 6 10])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[15 16 21])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[22 24 25])));
axis([0 120 -10 90])
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[26 32 45 48])));
axis([0 120 -10 90])
