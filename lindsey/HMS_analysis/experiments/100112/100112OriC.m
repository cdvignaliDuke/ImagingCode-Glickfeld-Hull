...
pn = 'G:\users\lindsey\analysisLG\100112\100112OriCRegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\100112\OriC';
...
save(fullfile(analpn,'OriCGFPneuronmasks.mat'),'mask_GFPneuron');
...
%subset figures
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,[10 20 27 42 50 60])));
axis([0 120 -10 90])
