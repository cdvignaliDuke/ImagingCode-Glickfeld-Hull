...
pn = 'G:\users\lindsey\analysisLG\090109\Ori2ARegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\090109\Ori2A';
analpn = 'g:\users\lindsey\analysisLG\090109';
...
save(fullfile(analpn,'Ori2Acellmasks.mat'),'mask_cell');
...
save(fullfile(analpn,'Ori2Aastromasks.mat'),'mask_astro')

%% reload masks
load 'g:\users\lindsey\analysisLG\09011205\Ori2Acellmasks.mat';
load 'g:\users\lindsey\analysisLG\081205\Ori2Aastromasks.mat';
...
save(fullfile(analpn,'Ori2Aneuronmasks.mat'),'mask_neuron')

%% cell time courses
load 'g:\users\lindsey\analysisLG\081205\OriAneuronmasks.mat';
