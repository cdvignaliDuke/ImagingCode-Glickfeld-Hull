...
pn = 'G:\users\lindsey\analysisLG\090706\OriCRegistered.tif';
pn2 = 'G:\users\lindsey\dataLG\090706\OriC';
analpn = 'g:\users\lindsey\analysisLG\090706';
...
% cell find code from MH
bwimgcell = imCellEditInteractive(img_green_adapt,[]);
mask_neuropil = bwlabel(bwimgcell);
image(mask_neuropil);
figure;
imagesq(imShade(img_green_adapt,mask_neuropil>0));
save(fullfile(analpn,'OriAneuropilmasks.mat'),'mask_neuropil');
...
%% cell time courses
load 'g:\users\lindsey\analysisLG\090615\OriAneuronmasks.mat';
...
figure;
tcOffsetPlot(tcRemoveDC(ratio(:,51:56)));
