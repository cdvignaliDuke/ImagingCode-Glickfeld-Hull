...
down=1 ;
nPlanes = 8;
base = 'G:\users\lindsey\analysisLG\active mice\LG27\110226\Z5';
expt = '110226_LG27_850nm_RG_Z5';
channel1 = '_green';
channel2 = '_red';
...
zstack2_green = reg;
fn_out_green = fullfile(outDir,sprintf('%s_green_reg.tif',expt));
...
writetiff(zstack2_green, fn_out_green);
fn_out_red = fullfile(outDir,sprintf('%s_blue_avg_reg.tif',expt));
