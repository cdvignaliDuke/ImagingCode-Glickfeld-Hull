...
for iArea = 1
    ...
    for iexp = [1 3 4]
        ...
        ind_highP = find(ttest_long(ind_local_max,:)>=(.01));
        ...
        fn_local = fullfile(outDir,'analysis',[date '_' mouse '_run' num2str(userun) '_local_max_ttest_pt01.mat']);
...
%         save(fn_stim, 'b', 'nPhoton');
        ...
        fn_out = fullfile(outDir, 'analysis', [date '_' mouse '_run' num2str(userun) '_resp_ttest_pt01.mat']);
        ...
        fn_out = fullfile(outDir, 'analysis', [date '_' mouse '_run' num2str(userun) '_Fit_struct_ttest_pt01.mat']);   
    ...
    if Nshuf>1;
        ...
        fn_out = fullfile(outDir, 'analysis', [date '_' mouse '_run' num2str(userun) '_lbub_fits_ttest_pt01_75%conf.mat']);   
