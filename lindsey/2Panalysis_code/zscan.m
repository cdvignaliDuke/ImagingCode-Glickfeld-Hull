...
nCond = 12;
nPlanes = 8;
epoch = ((nON + nOFF)*nCond)/nPlanes;

base = 'G:\users\lindsey\dataLG\110401_Y2\';
expt = 'run3';
channel = '_green';
fn= fullfile(base, expt, [expt channel]);
outDir = ['G:\users\lindsey\analysisLG\active mice\Y2\110401_',expt, channel];
stack = readtiff(fn);
