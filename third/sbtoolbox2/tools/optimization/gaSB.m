function [X,FVAL] = gaSB(varargin)
% gaSB: Standard Genetic Algorithm with elitism (3rd of the EvA2
% optimizers) 
%
...
% Germany 
%
% In case of a publication that was prepared using gaSB, users
...
if nargin == 0,
    ...
    X.name = 'gaSB';
    X.constrained = 1;
    X.description = 'Standard Genetic Algorithm with elitism (global)';      
