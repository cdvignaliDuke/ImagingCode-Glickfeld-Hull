function [X,FVAL] = chcSB(varargin)
% chcSB: Clustering multi-start hill climbing (10th of the
% EvA2 optimizers)    
%
...
% Germany 
%
% In case of a publication that was prepared using chcSB, users
...
if nargin == 0,
    ...
    X.name = 'chcSB';
    X.constrained = 1;
    X.description = 'Clustering multi-start hill climbing (global)';              
