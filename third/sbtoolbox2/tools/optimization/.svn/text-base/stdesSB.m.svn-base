function [X,FVAL] = stdesSB(varargin)
% stdesSB: A standard (15,50)-Evolution Strategy (1st of the EvA2
% optimizers)
%
...
% Germany 
%
% In case of a publication that was prepared using stdesSB, users
...
% ======
% [info] = stdesSB()
% [X,FVAL] = stdesSB(FUN,X)
% [X,FVAL] = stdesSB(FUN,X,OPTIONS)
%
...
if nargin == 0,
    X = [];
    X.name = 'stdesSB';
    X.description = 'Standard (15,50)-Evolution Strategy (global)';
    X.constrained = 1;
