function [X,FVAL] = hillSB(varargin)
% hillSB: Multi-start hill climbing (8th of the EvA2 optimizers)  
%
...
% Germany 
%
% In case of a publication that was prepared using hillSB, users
...
if nargin == 0,
    ...
    X.name = 'hillSB';
    X.constrained = 1;
    X.description = 'Multi-start hill climbing (global)';      
