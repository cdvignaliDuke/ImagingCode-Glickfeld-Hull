function [X,FVAL] = tribesSB(varargin)
% tribesSB: Tribes: an adaptive Particle Swarm Optimization (6th of the
% EvA2 optimizers)  
%
...
% Germany 
%
% In case of a publication that was prepared using tribesSB, users
...
% ======
% [info] = tribesSB()
% [X,FVAL] = tribesSB(FUN,X)
% [X,FVAL] = tribesSB(FUN,X,OPTIONS)
%
...
if nargin == 0,
    ...
    X.name = 'tribesSB';
    X.constrained = 1;
    X.description = 'Adaptive Particle Swarm Optimization (global)';
