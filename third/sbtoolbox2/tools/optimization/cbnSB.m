function [X,FVAL] = cbnSB(varargin)
% cbnSB: Clustering-based Niching Evolutionary Strategy (9th of the
% EvA2 optimizers)    
%
...
% Germany 
%
% In case of a publication that was prepared using cbnSB, users
...
if nargin == 0,
    ...
    X.name = 'cbnSB';
    X.constrained = 1;
    X.description = 'Clustering-based Niching Evolutionary Strategy (global)';                  
