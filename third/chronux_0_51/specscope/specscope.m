...
global acq;
    set(acq.offsetui,'String',sprintf( '%d', acq.offset ));
    set(acq.scaleui,'String',sprintf( '%d', acq.scale ));
    set(acq.log_ui,'Value',acq.log);
    set(acq.derivative_ui,'Value',acq.deriv);
    %set(acq.derivative2_ui,'Value',acq.deriv2);
    return
...
% Show instructions
  ...
  %fprintf('The second deriv checkbox toggles derivative of the spectrum\n');
...
function update_deriv2(varargin)
	 global acq;
     acq.deriv2=get( gco, 'Value' );
     acq.normalize=1;
     acq.restart=1;
     return
...
function fig=create_ui()
    ...
    uicontrol(gcf,'Style','text',...
        'String', 'deriv',...
        'Position',[555 20 35 20],...
        'BackgroundColor',bgcolor);
    uicontrol(gcf,'Style','text',...
        'String', 'log',...
        'Position',[585 20 35 20],...
        'BackgroundColor',bgcolor);
%     uicontrol(gcf,'Style','text',...
%         'String', 'deriv',...
%         'Position',[615 20 25 20],...
%         'BackgroundColor',bgcolor);

    % ===Tapers============================================
    uicontrol(gcf,'Style','edit',...
        'String', sprintf( '%.1f %.0f', acq.params.raw_tapers(1), acq.params.raw_tapers(2) ),...
    ...
    % ===Offset============================================
    acq.offsetui = uicontrol(gcf,'Style','edit',...
        'String', sprintf( '%d', acq.offset ),...
        'Position',[375 5 30 20],...
        'CallBack', @update_offset);

    % ===Scale============================================
    acq.scaleui = uicontrol(gcf,'Style','edit',...
...
%     % ===derivative2=====================================
%     acq.derivative2_ui = uicontrol(gcf,'Style','checkbox',...
%         'Value',acq.deriv2,...
%         'Position',[615 5 20 20],...
%         'CallBack', @update_deriv2);
%     
return
