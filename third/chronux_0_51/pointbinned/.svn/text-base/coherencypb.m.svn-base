function [C,phi,S12,S1,S2,f,zerosp,confC,phierr,Cerr]=coherencypb(data1,data2,params,fscorr)
...
[J1,Msp1,Nsp1]=mtfftpb(data1,tapers,nfft);
[J2,Msp2,Nsp2]=mtfftpb(data2,tapers,nfft);
C1=size(J1,3); 
