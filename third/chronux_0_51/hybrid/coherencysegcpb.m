function [C,phi,S12,S1,S2,f,zerosp,confC,phierr,Cerr]=coherencysegcpb(data1,data2,win,params,segave,fscorr)
...
%
% Usage:
% [C,phi,S12,S1,S2,f,zerosp,confC,phierr,Cerr]=coherencysegcpb(data1,data2,win,params,segave,fscorr)
% Input: 
...
elseif nargout==9; 
  [C,phi,S12,S1,S2,f,zerosp,confC,phierr]=coherencycpb(data1,data2,params,fscorr); % compute coherency for segmented data
elseif nargout==10;
  [C,phi,S12,S1,S2,f,zerosp,confC,phierr,Cerr]=coherencycpb(data1,data2,params,fscorr); % compute coherency for segmented data
end;
