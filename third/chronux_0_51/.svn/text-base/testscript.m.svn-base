...
%     fscorr=1;
% end;
pname='/home/histed/posit-matlab-core/third/chronux_0_51/data';
...
% Load data
%
%eval(['load ' pname '/LIPdata.mat']);
load(fullfile(pname,'LIPdata.mat'));
% %
...
NT=round(10*movingwin(1)*params.Fs); 
...
% $$$ figure; subplot(211);plot(f,10*log(S)); varS
