...
save(fullfile(fnout, [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_pixel.mat']),'pix_fgta','pix_fgtn','pix')
save(fullfile(fnout, [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_transform.mat']), 'input_points', 'base_points', 'data_dfof_max_ref', 'ref','reg','fitGeoTAf','r2rFGTA','r2rFGTA_dfof','fitGeoTNr','r2rFGTN','r2rFGTN_dfof');
