...
%% Register data
% these are the 500 frames that we have selected to register the entire
% dataset to
...
%         obtaining dfof and formatting it as a four dim array
...
%     on day 1 to create a cell mask that will overlap the FOVs of
%     following days
...
%     rgb_ref2ref is using data_reg_avg, and rgb_reg2red_dfof is using
%     data_dfof_max
