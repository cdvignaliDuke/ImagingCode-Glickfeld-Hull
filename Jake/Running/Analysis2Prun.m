...
%}
clear;
pathname = ['S:\2PImaging\160224_img39\img39\'];
moviename = ['img39_000_003'];
moviefile = [pathname moviename '.sbx'];
nframes = 30849;
%% Load movie, adjust baseline
tiffmovie = [pathname 'img39_1.tif'];
...
save([pathname 'newPC_1'], 'PCuse' ,'mixedsig' ,'mixedfilters', 'CovEvals', 'covtrace' ,'movm', 'movtm','ica_sig', 'ica_filters', 'ica_A', 'numiter', 'sm', 'timeCourses')
