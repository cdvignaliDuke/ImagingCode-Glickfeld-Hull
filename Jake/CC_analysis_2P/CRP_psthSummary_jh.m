...
%         ylim([-1 6])
%         xlim([-500 2000])
%         if prerew_max_ind_rew > mean(base_avg(:,ind),2)+base_std_all.*thresh
...
%         text(0,8,[num2str(chop(mean(late_preresp_rew,2),2)) '+/-' num2str(chop(std(late_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','b')
%         text(0,9,[num2str(chop(mean(early_preresp_rew,2),2)) '+/-' num2str(chop(std(early_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%         text(0,8,[num2str(chop(mean(late_postresp_rew,2),2)) '+/-' num2str(chop(std(late_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','b')
%         text(0,9,[num2str(chop(mean(early_postresp_rew,2),2)) '+/-' num2str(chop(std(early_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             scatter(rew_preresp_rew,omit_preresp_rew)
%             hold on
%             errorbarxy(mean(rew_preresp_rew,2),mean(omit_preresp_rew,2),std(rew_preresp_rew,[],2)./sqrt(totIC_area), std(omit_preresp_rew,[],2)./sqrt(totIC_area),{'or', 'r','r'});
%             text(0,8,[num2str(chop(mean(omit_preresp_rew,2),2)) '+/-' num2str(chop(std(omit_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(rew_preresp_rew,2),2)) '+/-' num2str(chop(std(rew_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             scatter(rew_postresp_rew,omit_postresp_rew)
%             hold on
%             errorbarxy(mean(rew_postresp_rew,2),mean(omit_postresp_rew,2),std(rew_postresp_rew,[],2)./sqrt(totIC_area), std(omit_postresp_rew,[],2)./sqrt(totIC_area),{'or', 'r','r'});
%             text(0,8,[num2str(chop(mean(omit_postresp_rew,2),2)) '+/-' num2str(chop(std(omit_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(rew_postresp_rew,2),2)) '+/-' num2str(chop(std(rew_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             text(0,8,[num2str(chop(mean(omit_preresp_omit,2),2)) '+/-' num2str(chop(std(omit_preresp_omit,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(rew_preresp_omit,2),2)) '+/-' num2str(chop(std(rew_preresp_omit,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             text(0,8,[num2str(chop(mean(omit_postresp_omit,2),2)) '+/-' num2str(chop(std(omit_postresp_omit,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(rew_postresp_omit,2),2)) '+/-' num2str(chop(std(rew_postresp_omit,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             text(0,8,[num2str(chop(mean(unexp_preresp_rew,2),2)) '+/-' num2str(chop(std(unexp_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(rew_preresp_rew,2),2)) '+/-' num2str(chop(std(rew_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([prerew_max_ind_rew-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,8,[num2str(chop(mean(unexp_postresp_rew,2),2)) '+/-' num2str(chop(std(unexp_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(rew_postresp_rew,2),2)) '+/-' num2str(chop(std(rew_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([postrew_max_ind_rew+rewdelay_frames-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,8,[num2str(chop(mean(unexp_preresp_unexp,2),2)) '+/-' num2str(chop(std(unexp_preresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(rew_preresp_unexp,2),2)) '+/-' num2str(chop(std(rew_preresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             text(0,8,[num2str(chop(mean(unexp_postresp_unexp,2),2)) '+/-' num2str(chop(std(unexp_postresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(rew_postresp_unexp,2),2)) '+/-' num2str(chop(std(rew_postresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%             text(0,9,[num2str(chop(mean(base_preresp_rew,2),2)) '+/-' num2str(chop(std(base_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(0,8,[num2str(chop(mean(rew_preresp_rew,2),2)) '+/-' num2str(chop(std(rew_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(10,0,[num2str([prerew_max_ind_rew-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,9,[num2str(chop(mean(base_postresp_rew,2),2)) '+/-' num2str(chop(std(base_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(0,8,[num2str(chop(mean(rew_postresp_rew,2),2)) '+/-' num2str(chop(std(rew_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(10,0,[num2str([postrew_max_ind_rew+rewdelay_frames-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,8,[num2str(chop(mean(omit_preresp_omit,2),2)) '+/-' num2str(chop(std(omit_preresp_omit,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(base_preresp_omit,2),2)) '+/-' num2str(chop(std(base_preresp_omit,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([prerew_max_ind_omit-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,8,[num2str(chop(mean(omit_postresp_omit,2),2)) '+/-' num2str(chop(std(omit_postresp_omit,[],2),2))],'HorizontalAlignment','center','Color','r')
%             text(0,9,[num2str(chop(mean(base_postresp_omit,2),2)) '+/-' num2str(chop(std(base_postresp_omit,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([postrew_max_ind_omit+rewdelay_frames-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             text(0,8,[num2str(chop(mean(rew_preresp_rew,2),2)) '+/-' num2str(chop(std(rew_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(base_preresp_rew,2),2)) '+/-' num2str(chop(std(base_preresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([prerew_max_ind_rew-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             scatter(rew_postresp_rew,base_postresp_rew)
%             hold on
%             errorbarxy(mean(rew_postresp_rew,2),mean(base_postresp_rew,2),std(rew_postresp_rew,[],2)./sqrt(totIC_area), std(base_postresp_rew,[],2)./sqrt(totIC_area),{'og', 'g','g'});
%             text(0,8,[num2str(chop(mean(rew_postresp_rew,2),2)) '+/-' num2str(chop(std(rew_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(base_postresp_rew,2),2)) '+/-' num2str(chop(std(base_postresp_rew,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([postrew_max_ind_rew+rewdelay_frames-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             title(['PostRew rew peak- p = ' num2str(chop(p_postresp_rew,2))],'Color',tit_str2)
%             subplot(3,2,5)
%             base_preresp_unexp = mean(all_unexp_sub(prewin_frames-rewdelay_frames-rewdelay_frames+base_max_ind_unexp-1:prewin_frames-rewdelay_frames-rewdelay_frames+base_max_ind_unexp+1,ind),1);
%             unexp_preresp_unexp = mean(all_unexp_sub(prewin_frames+prerew_max_ind_unexp-1:prewin_frames+prerew_max_ind_unexp+1,ind),1);
...
%             text(0,8,[num2str(chop(mean(unexp_preresp_unexp,2),2)) '+/-' num2str(chop(std(unexp_preresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(base_preresp_unexp,2),2)) '+/-' num2str(chop(std(base_preresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([prerew_max_ind_unexp-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%             title(['PreRew unexp - p = ' num2str(chop(p_preresp_unexp,2))],'Color',tit_str3)
%             subplot(3,2,6)
%             base_postresp_unexp = mean(all_unexp_sub(prewin_frames-rewdelay_frames-rewdelay_frames+base_max_ind_unexp-1:prewin_frames-rewdelay_frames-rewdelay_frames+base_max_ind_unexp+1,ind),1);
%             unexp_postresp_unexp = mean(all_unexp_sub(prewin_frames+rewdelay_frames+postrew_max_ind_unexp-1:prewin_frames+rewdelay_frames+postrew_max_ind_unexp+1,ind),1);
%             scatter(unexp_postresp_unexp,base_postresp_unexp)
%             hold on
%             errorbarxy(mean(unexp_postresp_unexp,2),mean(base_postresp_unexp,2),std(unexp_postresp_unexp,[],2)./sqrt(totIC_area), std(base_postresp_unexp,[],2)./sqrt(totIC_area),{'og', 'g','g'});
%             text(0,8,[num2str(chop(mean(unexp_postresp_unexp,2),2)) '+/-' num2str(chop(std(unexp_postresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','g')
%             text(0,9,[num2str(chop(mean(base_postresp_unexp,2),2)) '+/-' num2str(chop(std(base_postresp_unexp,[],2),2))],'HorizontalAlignment','center','Color','k')
%             text(10,0,[num2str([postrew_max_ind_unexp+rewdelay_frames-1].*1000/frameRateHz) ' ms'],'HorizontalAlignment','right','Color','k')
...
%         set(gcf,'Units', 'inches', 'Position',[0 0 8 11])
%         suptitle(['Day ' num2str(id) ' Area' area_list{i} ': n= ' num2str(totIC_area) ' dendrites'])
%         savefig([share_out '\CC_summary\Day' num2str(id) '\Day' num2str(id) '_Summary_Area' area_list{i} '_Summary_peakSpikingResp_Thresh' num2str(thresh) '_BaseComp_onetail' mouse_str '.fig'])
%     end
%     
%     
%     for i = find(sum(expt_areas,2)')
...
%             scatter(mean(all_rew_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1), mean(all_unexp_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1))
%             hold on
%             errorbarxy(mean(mean(all_rew_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1),2),mean(mean(all_unexp_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1),2),std(mean(all_rew_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1),[],2)./sqrt(totIC_area), std(mean(all_unexp_df_sub(prewin_frames+prerew_max_ind_rew-2:prewin_frames+prerew_max_ind_rew,ind),1),[],2)./sqrt(totIC_area),{'og', 'g','g'});
...
%             title('Pre reward window')
%             subplot(2,2,4)
%             scatter(mean(all_rew_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1), mean(all_unexp_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1))
%             hold on
%             errorbarxy(mean(mean(all_rew_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1),2),mean(mean(all_unexp_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1),2),std(mean(all_rew_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1),[],2)./sqrt(totIC_area), std(mean(all_unexp_df_sub(prewin_frames+rewdelay_frames+postrew_max_ind_rew-2:prewin_frames+rewdelay_frames+postrew_max_ind_rew,ind),1),[],2)./sqrt(totIC_area),{'og', 'g','g'});
%             ylabel('Unexpected Reward- dF/F')
%             xlabel('Reward- dF/F')
%             xlim([-0.2 0.5])
%             ylim([-0.2 0.5])
...
%         text(0,8,[num2str(chop(nanmean(lastLick_preRew_last_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_last_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%         text(0,9,[num2str(chop(nanmean(firstLick_postRew_last_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_last_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%         text(0,8,[num2str(chop(nanmean(lastLick_preRew_first_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_first_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%         text(0,9,[num2str(chop(nanmean(firstLick_postRew_first_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_first_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
...
%                 text(0,8,[num2str(chop(nanmean(lastLick_preRew_last_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_last_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(0,9,[num2str(chop(nanmean(lastLick_preRew_omit_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_omit_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(10,0,[num2str(chop(tl_rew(maxind_lastLick_preRew_rew),2)) ' ms'],'HorizontalAlignment','right','Color','k')
...
%                 text(0,8,[num2str(chop(nanmean(firstLick_postRew_first_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_first_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(0,9,[num2str(chop(nanmean(firstLick_postRew_omit_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_omit_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(10,0,[num2str(chop(tl_rew(maxind_firstLick_postRew_rew),2)) ' ms'],'HorizontalAlignment','right','Color','k')
...
%                 text(0,8,[num2str(chop(nanmean(lastLick_preRew_last_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_last_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(0,9,[num2str(chop(nanmean(lastLick_preRew_unexp_sub,2),2)) '+/-' num2str(chop(nanstd(lastLick_preRew_unexp_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(10,0,[num2str(chop(tl_rew(maxind_lastLick_preRew_rew),2)) ' ms'],'HorizontalAlignment','right','Color','k')
...
%                 text(0,8,[num2str(chop(nanmean(firstLick_postRew_first_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_first_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(0,9,[num2str(chop(nanmean(firstLick_postRew_unexp_sub,2),2)) '+/-' num2str(chop(nanstd(firstLick_postRew_unexp_sub,[],2),2))],'HorizontalAlignment','center','Color','k')
%                 text(10,0,[num2str(chop(tl_rew(maxind_firstLick_postRew_rew),2)) ' ms'],'HorizontalAlignment','right','Color','k')
