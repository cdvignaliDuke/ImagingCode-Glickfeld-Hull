...
for id = 4
    ...
    for iexp = :nexp
        ...
        load(fullfile(jh_out,img_fn, [img_fn '_input.mat']))
        ...
        suptitle([date ' ' mouse])
        savefig(fullfile(jh_out,img_fn, [img_fn '_cueAlign_lickHz.fig']))
        ...
        savefig(fullfile(jh_out,img_fn, [img_fn '_cueAlignSpiking_byLickTime.fig']))
        end
        ...
        savefig(fullfile(jh_out,img_fn, [img_fn '_postRew_lickAlignSpiking.fig']))
        ...
        savefig(fullfile(jh_out,img_fn, [img_fn '_lastVsFirstLick.fig'])) 
        ...
        savefig(fullfile(jh_out,img_fn, [img_fn '_cueAlignSpiking_byLickRate.fig'])) 
