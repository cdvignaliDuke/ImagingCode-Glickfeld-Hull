...
PLOT_RUN = 1;
% --- pcp2 mouse
  image_dest  = 'Z:\Data\WidefieldImaging\GCaMP\150209_img21_1\150209_img21_1_MMStack.ome.tif';
 behave_dest =  'Z:\Data\WidefieldImaging\GCaMP\150209_img21_1\data-img21-150209-1728';
 % first_frame = 25; % In this day the first 25 frames were off
  first_frame = 85; % Usually the first one or two trials are messed up 
  last_frame = 1260;
  Sampeling_rate = 4;
...
if(PLOT_RUN)
    p_run  = mouse_run(first_frame:last_frame);
    p_run = p_run -nanmean(p_run);
    p_run = p_run./nanstd(p_run);
    plot(first_frame:last_frame, p_run,'r'); hold on;
end
