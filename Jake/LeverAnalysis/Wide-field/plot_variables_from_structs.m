...
clear;
all_days = {'150716_img28', '150717_img28', '151022_img29', '151009_img30', '151011_img30', '151211_img32', '151212_img32', '160129_img35', '160131_img35', '160129_img36','160131_img36', '160314_img38', '160315_img38', '160319_img41', '160320_img41', '160606_img46'}; %not really all days but it was the days I had LS ROIs selected for already
...
for ii = 1: length(corr_magnitude_mean)
    plot(corr_magnitude_mean(ii), early_magnitude_mean(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([0, 0.4]);
ylim([0, 0.4]);
title('onset latency standard deviations');
...
for ii = 1: length(corr_onset_latency_std)
    plot(corr_onset_latency_std(ii), early_onset_latency_std(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([60, 260]);
ylim([60, 260]);
...
figure; hold on;
for ii = 1:length(corr_onset_latency_std)
    plot(corr_onset_latency_std(ii), corr_cue_aligned_onset_latency_std(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([50, 250]);
ylim([50, 250]);
...
for ii = 1:length(corr_onset_latency)
    plot(corr_onset_latency(ii), early_onset_latency(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([-250, 100]);
ylim([-250, 100]);
title('mean onset latencies');
...
for ii = 1:length(corr_peak_latency_std)
    plot(corr_peak_latency_std(ii), corr_cue_aligned_peak_latency_std(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([-350, 350]);
ylim([-350, 350]);
...
for ii = 1:length(corrEarlyRatio)
    plot(corrEarlyRatio(ii), percent_corr(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
xlim([0, 3]);
ylim([0, 100]);
title('fluorescence response ratio and percent correct');
...
%plot ratio as a function of peak percent correct
figure; hold on;
for ii = 1:length(corrEarlyRatio)
    plot(corrEarlyRatio(ii), peak_percent_corr(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
xlim([0, 3]);
ylim([0, 100]);
title('fluorescence response ratio and percent correct');
...
figure; hold on;
for ii = 1:length(corrEarlyRatio)
    plot(corrEarlyRatio(ii), training_day_num(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
xlim([1, 3]);
ylim([15, 55]);
...
figure; hold on;
for ii = 1:length(corrEarlyRatio)
    plot(corrEarlyRatio(ii), recent_corr(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
xlim([1, 3]);
ylim([0, 100]);
...
%figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        %plot(corr_react_times(sample_trial_nums), corr_onset_latency(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        sample_trial_nums = round(linspace(1,length(corr_react_times), 25));
        plot(corr_react_times(sample_trial_nums), corr_magnitude(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
xlabel('reaction times for correct trials (ms)')
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        sample_trial_nums = round(linspace(1,length(corr_react_times), 25));
        plot(corr_react_times(sample_trial_nums), corr_peak_times(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
xlabel('reaction times for correct trials (ms)')
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        sample_trial_nums = round(linspace(1,length(corr_react_times), 25));
        plot(corr_react_times(sample_trial_nums), corr_cue_aligned_peak_latency(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
xlabel('reaction times for correct trials (ms)')
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        sample_trial_nums = round(linspace(1,length(corr_react_times), 25));
        plot(corr_react_times(sample_trial_nums), corr_cue_aligned_onset_latency(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
xlabel('reaction times for correct trials (ms)')
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        sample_trial_nums = round(linspace(1,length(corr_react_times), 25));
        plot(corr_react_times(sample_trial_nums), corr_rise_times(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
xlabel('reaction times for correct trials (ms)')
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        plot(corr_hold_dur(sample_trial_nums), corr_magnitude(sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
...
figure; hold on;
    for ii = 1:length(days_chrono_order);
        ...
        plot(corr_rise_times(sample_trial_nums), early_rise_times(early_sample_trial_nums), 'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
    end
    xlim([0 400]);
    ylim([0 400]);
...
for ii = 1: length(corr_rise_time_mean)
    plot(corr_rise_time_mean(ii), early_rise_time_mean(ii),'Marker', 'o', 'Linestyle', 'none', 'Color', color_pallet(ii,:));
end
hold on; plot(x,y, 'Color', 'k', 'Linestyle', '--');
xlim([0, 400]);
ylim([0, 400]);
