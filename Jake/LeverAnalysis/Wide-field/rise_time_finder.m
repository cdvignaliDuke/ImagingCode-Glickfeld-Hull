...
corr_lat  = curr_struct.corr_peak_latency_release+600;
early_lat = curr_struct.early_peak_latency_release+600;
cue_lat   = curr_struct.cue_peak_latency+600;
corr_cue_aligned_lat = curr_struct.corr_cue_aligned_peak_latency+600;
