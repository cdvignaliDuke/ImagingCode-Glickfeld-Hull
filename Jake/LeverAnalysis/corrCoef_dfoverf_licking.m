...
colors = {'r', 'b', 'b', 'm', 'g', 'g', 'k', 'c', 'k'};
days = {'160129_img36', '160129_img35', '160131_img35', '151211_img32', '150717_img28', '150716_img28', '150718_img27', '151022_img29', '150719_img27'};
DATA_DIR = 'Z:\Analysis\LeverAnalysis\CorrCoefSummary\';
%DATA_DIR = 'Z:\Analysis\LeverAnalysis\LeverSummaryNoShift\';
summary_coef = {}; 
for kk = 1:length(days)
    curr_file_coef = strcat(DATA_DIR, days{kk}, '_corrCoef');
