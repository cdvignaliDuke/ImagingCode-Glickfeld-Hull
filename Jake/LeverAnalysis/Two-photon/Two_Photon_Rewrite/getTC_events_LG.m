...
% else
    ...
    % ---- parse behavior
    holdT_min  = 500000;  %us
    [lever, frame_info, trial_outcome, lick_data] = cleanBehav_LG(input, ifi, holdT_min);
    frame_info.ifi = ifi;
...
%     lick_data.lickRateF(remove_idx) = [];
    ...
    save([dest  'parse_behavior_LG.mat'], 'lever', 'frame_info', 'trial_outcome', 'lick_data', 'Sampeling_rate', 'holdT_min', 'ifi')
...
%     
    save([dest '_lick_movies_LG.mat'], 'lick_movie', 'single_lick_movie');
    
    save([dest '_lick_stats_LG.mat'], 'success_lick', 'itiR_lick', 'omitR_lick', 'fail_lick', 'success_lick_long', 'fail_lick_long', 'omitR_lick_long', 'itiR_lick_long',...
