...
%fig=figure 1 -percent correct after a press CS or no CS each trial
fig=figure;
allPrev = [];
allThis = [];
allNext = [];
...
for id = 1:size(mouseID,2)
    ...
    subplot(2,2,1)
    plot(pctCorrectPrev_press_CS{id}(:,1), pctCorrectPrev_press_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allPrev = [allPrev; pctCorrectPrev_press_CS{id}(:,1) pctCorrectPrev_press_noCS{id}(:,1)];
    hold on
    subplot(2,2,2)
    plot(pctCorrectThis_press_CS{id}(:,1), pctCorrectThis_press_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allThis = [allThis; pctCorrectThis_press_CS{id}(:,1) pctCorrectThis_press_noCS{id}(:,1)];
    hold on
    subplot(2,2,3)
    plot(pctCorrectNext_press_CS{id}(:,1), pctCorrectNext_press_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allNext = [allNext; pctCorrectNext_press_CS{id}(:,1) pctCorrectNext_press_noCS{id}(:,1)];
    hold on
    subplot(2,2,4)
    plot(pctCorrectSecond_press_CS{id}(:,1), pctCorrectSecond_press_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
...
supertitle('Prediction of outcome by trial order by press CS')
saveas(fig, [out_base 'Summary_pctcorr_pressCSnoCS_byoutcome.fig']);
...
for id = 1:size(mouseID,2)
    ...
    subplot(2,2,1)
    plot(pctCorrectPrev_success_CS{id}(:,1), pctCorrectPrev_success_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allPrev = [allPrev; pctCorrectPrev_success_CS{id}(:,1) pctCorrectPrev_success_noCS{id}(:,1)];
    hold on
    subplot(2,2,2)
    plot(pctCorrectNext_success_CS{id}(:,1), pctCorrectNext_success_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allNext = [allNext; pctCorrectNext_success_CS{id}(:,1) pctCorrectNext_success_noCS{id}(:,1)];
    hold on
    subplot(2,2,3)
    plot(pctCorrectSecond_success_CS{id}(:,1), pctCorrectSecond_success_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
...
supertitle('Prediction of outcome by trial order by success CS')
saveas(fig, [out_base 'Summary_pctcorr_successCSnoCS_byoutcome.fig']);
...
for id = 1:size(mouseID,2)
    ...
    subplot(2,2,1)
    plot(pctCorrectPrev_fail_CS{id}(:,1), pctCorrectPrev_fail_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allPrev = [allPrev; pctCorrectPrev_fail_CS{id}(:,1) pctCorrectPrev_fail_noCS{id}(:,1)];
    hold on
    subplot(2,2,2)
    plot(pctCorrectNext_fail_CS{id}(:,1), pctCorrectNext_fail_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    allNext = [allNext; pctCorrectNext_fail_CS{id}(:,1) pctCorrectNext_fail_noCS{id}(:,1)];
    hold on
    subplot(2,2,3)
    plot(pctCorrectSecond_fail_CS{id}(:,1), pctCorrectSecond_fail_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
...
supertitle('Prediction of outcome by trial order by fail CS')
saveas(fig, [out_base 'Summary_pctcorr_failCSnoCS_byoutcome.fig']);
...
%fig=figure 2 -percent correct after a press CS on Prev, this, next, second
%trials
fig=figure;
cid = 1;
for id = 1:size(mouseID,2)
    ...
    subplot(2,3,1)
    plot(pctCorrectPrev_press_CS{id}(:,1), pctCorrectNext_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,3,2)
    plot(pctCorrectPrev_press_CS{id}(:,1), pctCorrectSecond_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,3,3)
    plot(pctCorrectNext_press_CS{id}(:,1), pctCorrectSecond_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,3,4)
    plot(pctCorrectThis_press_CS{id}(:,1), pctCorrectPrev_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,3,5)
    plot(pctCorrectThis_press_CS{id}(:,1), pctCorrectNext_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,3,6)
    plot(pctCorrectThis_press_CS{id}(:,1), pctCorrectSecond_press_CS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
end
x = 0:.01:1;
y = x;
...
supertitle('Prediction of outcome on this trial by press CS')
saveas(fig, [out_base 'Summary_pctcorr_failCSnoCS_byoutcome.fig']);
print([out_base 'Summary_probCS_press_byoutcome.eps'], '-depsc');
print([out_base 'Summary_probCS_press_byoutcome.pdf'], '-dpdf');

%fig=figure 2 -percent correct after a press CS or no CS THIS trial
fig=figure;
cid = 1;
for id = 1:size(mouseID,2)
    if id > 1 && ~strcmp(mouseID{id},mouseID{id-1})
    ...
    subplot(2,2,1)
    plot(pctCorrectNext_success_CS{id}(:,1), pctCorrectSecond_success_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,2,2)
    plot(pctCorrectNext_fail_CS{id}(:,1), pctCorrectSecond_fail_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,2,3)
    plot(pctCorrectNext_success_CS{id}(:,1), pctCorrectPrev_success_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
    subplot(2,2,4)
    plot(pctCorrectNext_fail_CS{id}(:,1), pctCorrectPrev_fail_noCS{id}(:,1), 'o', 'color', col_mat(cid,:));
    hold on
end
x = 0:.01:1;
y = x;
...
supertitle('Prediction of outcome on this trial by release CS')
saveas(fig, [out_base 'Summary_probCS_release_byoutcome.fig']);
...
for id = 1:size(mouseID,2)
    ...
    scatter(pctCorrectNext_success_CS_sub, pctCorrectNext_success_noCS_sub, 'MarkerEdgeColor',  col_mat(cid,:))
    hold on
    subplot(2,2,2)
    ...
    scatter(pctCorrectNext_fail_CS_sub, pctCorrectNext_fail_noCS_sub, 'MarkerEdgeColor',  col_mat(cid,:))
    hold on
    subplot(2,2,3)
    ...
    scatter(pctCorrectNext_release_CS_sub, pctCorrectNext_release_noCS_sub, 'MarkerEdgeColor',  col_mat(cid,:))
    hold on
    subplot(2,2,4)
    ...
    scatter(pctCorrectNext_press_CS_sub, pctCorrectNext_press_noCS_sub, 'MarkerEdgeColor',  col_mat(cid,:))
    hold on
end
x = -1:0.1:1;
y = -x;
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on next trial'])
saveas(fig, [out_base 'Summary_diff_event_outcome.fig']);
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on next trial- 100 ms'])
saveas(fig, [out_base 'Summary_diff_event_outcome_100ms.fig']);
...
for id = 1:size(mouseID,2)
    ...
    scatter(pctCorrectRand_success_CS_sub, pctCorrectRand_success_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,2)
    ...
    scatter(pctCorrectRand_fail_CS_sub, pctCorrectRand_fail_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,3)
    ...
    scatter(pctCorrectRand_release_CS_sub, pctCorrectRand_release_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,4)
    ...
    scatter(pctCorrectRand_press_CS_sub, pctCorrectRand_press_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
end
subplot(2,2,1)
xlim([-1 1])
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on random trial'])
saveas(fig, [out_base 'Summary_diff_event_outcome_rand.fig']);
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on random trial- 100 ms'])
saveas(fig, [out_base 'Summary_diff_event_outcome_100ms_rand.fig']);
...
for id = 1:size(mouseID,2)
    ...
    scatter(pctCorrectSecond_success_CS_sub, pctCorrectSecond_success_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,2)
    ...
    scatter(pctCorrectSecond_fail_CS_sub, pctCorrectSecond_fail_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,3)
    ...
    scatter(pctCorrectSecond_release_CS_sub, pctCorrectSecond_release_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,4)
    ...
    scatter(pctCorrectSecond_press_CS_sub, pctCorrectSecond_press_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
end
subplot(2,2,1)
xlim([-1 1])
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on second trial'])
saveas(fig, [out_base 'Summary_diff_event_outcome_second.fig']);
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on second trial- 100 ms'])
saveas(fig, [out_base 'Summary_diff_event_outcome_second_100ms.fig']);
...
for id = 1:size(mouseID,2)
    ...
    scatter(pctCorrectPrev_success_CS_sub, pctCorrectPrev_success_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,2)
    ...
    scatter(pctCorrectPrev_fail_CS_sub, pctCorrectPrev_fail_noCS_sub, 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,3)
    ...
    scatter(pctCorrectPrev_release_CS_sub, pctCorrectPrev_release_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,4)
    ...
    scatter(pctCorrectPrev_press_CS_sub, pctCorrectPrev_press_noCS_sub,'MarkerEdgeColor', col_mat(cid,:))
    hold on
end
subplot(2,2,1)
xlim([-1 1])
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on prev trial'])
saveas(fig, [out_base 'Summary_diff_event_outcome_prev.fig']);
...
ylabel('Diff- no CS')
title('Press')
supertitle(['Difference from average %correct on prev trial- 100 ms'])
saveas(fig, [out_base 'Summary_diff_event_outcome_prev_100ms.fig']);
...
for id = 1:size(mouseID,2)
    ...
    subplot(2,2,1)
    scatter(pctCorrectNext_success_CS{id}(:,1),pctCorrectNext_fail_CS{id}(:,1),'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,2)
    scatter(pctCorrectNext_success_CS{id}(:,2),pctCorrectNext_fail_CS{id}(:,2), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,3)
    scatter(nanmean(pctCorrectNext_success_CS{id}(:,1),1),nanmean(pctCorrectNext_fail_CS{id}(:,1),1), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,4)
    scatter(nanmean(pctCorrectNext_success_CS{id}(:,2),1),nanmean(pctCorrectNext_fail_CS{id}(:,2),1), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
end
x = 0:.1:1;
y = x;
...
supertitle(['%correct on next trial after CS on Success/Fail'])
saveas(fig, [out_base 'Summary_pctcorrect_bySF.fig']);
...
for id = 1:size(mouseID,2)
    ...
    subplot(2,2,1)
    scatter(pctCorrectNext_release_CS{id}(:,1),pctCorrectNext_press_CS{id}(:,1), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,2)
    scatter(pctCorrectNext_release_CS{id}(:,2),pctCorrectNext_press_CS{id}(:,2), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,3)
    scatter(nanmean(pctCorrectNext_release_CS{id}(:,1),1),nanmean(pctCorrectNext_press_CS{id}(:,1),1), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
    subplot(2,2,4)
    scatter(nanmean(pctCorrectNext_release_CS{id}(:,2),1),nanmean(pctCorrectNext_press_CS{id}(:,2),1), 'MarkerEdgeColor', col_mat(cid,:))
    hold on
end
x = 0:.1:1;
y = x;
...
ylabel('CS press')
title('avg % correct - short')
supertitle(['%correct on next trial after CS on release/press'])
saveas(fig, [out_base 'Summary_pctcorrect_byRP.fig']);
