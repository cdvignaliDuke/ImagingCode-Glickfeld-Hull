 function [trigger_licks, trigger_licks_10ms, lick] = trigger_movie_licks_2P_CRP(frame_info, licking_data, use_event_times, trigger_vars)
 ...
 % if there is no licking data then exit function
