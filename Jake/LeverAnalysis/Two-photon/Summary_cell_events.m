...
%     errorbarxy(mean(rp_peak(1,rp_use),2), mean(rp_peak(2,rp_use),2), std(rp_peak(1,rp_use),[],2)./sqrt(length(rp_use)), std(rp_peak(2,rp_use),[],2)./sqrt(length(rp_use)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)});
%     hold on
...
%     errorbarxy(mean(sf_peak(1,sf_use),2), mean(sf_peak(2,sf_use),2),std(sf_peak(1,sf_use),[],2)./sqrt(length(sf_use)), std(sf_peak(2,sf_use),[],2)./sqrt(length(sf_use)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)});
%     hold on
...
%     errorbarxy(mean(rp_peak_RS(1,rp_use_RS),2), mean(rp_peak_RS(2,rp_use_RS),2), std(rp_peak_RS(1,rp_use_RS),[],2)./sqrt(length(rp_use_RS)), std(rp_peak_RS(2,rp_use_RS),[],2)./sqrt(length(rp_use_RS)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)});
%     hold on
...
%     errorbarxy(mean(sf_peak_RS(1,sf_use_RS),2), mean(sf_peak_RS(2,sf_use_RS),2), std(sf_peak_RS(1,sf_use_RS),[],2)./sqrt(length(sf_use_RS)), std(sf_peak_RS(2,sf_use_RS),[],2)./sqrt(length(sf_use_RS)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)});
%     hold on
...
for id = 1:size(date_mat,1)
    subplot(2,2,1)
    errorbarxy(mean(success_rate{id},2), mean(fail_rate{id},2), std(success_rate{id},[],2)./sqrt(size(success_rate{id},2)),std(fail_rate{id},[],2)./sqrt(size(fail_rate{id},2)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on
    scatter(mean(success_rate{id},2), mean(fail_rate{id},2), col_mat(id,:))    
    subplot(2,2,2)
    errorbarxy(mean(success_RS_rate{id},2), mean(fail_RS_rate{id},2), std(success_RS_rate{id},[],2)./sqrt(size(success_RS_rate{id},2)),std(fail_RS_rate{id},[],2)./sqrt(size(fail_RS_rate{id},2)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on
    scatter(mean(success_RS_rate{id},2), mean(fail_RS_rate{id},2), col_mat(id,:))
    subplot(2,2,3)
    errorbarxy(mean(success_ind{id},2), mean(fail_ind{id},2), std(success_ind{id},[],2)./sqrt(size(success_ind{id},2)),std(fail_ind{id},[],2)./sqrt(size(fail_ind{id},2)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on
    scatter(mean(success_ind{id},2), mean(fail_ind{id},2), col_mat(id,:))
    subplot(2,2,4)
    errorbarxy(mean(success_RS_ind{id},2), mean(fail_RS_ind{id},2), std(success_RS_ind{id},[],2)./sqrt(size(success_RS_ind{id},2)),std(fail_RS_ind{id},[],2)./sqrt(size(fail_RS_ind{id},2)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on
...
for id = 1:size(date_mat,1) 
    ...
    errorbarxy(mean(temp_release(:,use_cells_all),2), mean(temp_press(:,use_cells_all),2), std(temp_release(:,use_cells_all),[],2)./sqrt(length(use_cells_all)), std(temp_press(:,use_cells_all),[],2)./sqrt(length(use_cells_all)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on;
    scatter(mean(temp_release(:,use_cells_all),2), mean(temp_press(:,use_cells_all),2), col_mat(id,:))
    subplot(1,2,2)
    errorbarxy(mean(temp_release_RS(:,use_cells_RS),2), mean(temp_press_RS(:,use_cells_RS),2), std(temp_release_RS(:,use_cells_RS),[],2)./sqrt(length(use_cells_RS)), std(temp_press_RS(:,use_cells_RS),[],2)./sqrt(length(use_cells_RS)),{['o' col_mat(id,:)], col_mat(id,:),col_mat(id,:)})
    hold on;
