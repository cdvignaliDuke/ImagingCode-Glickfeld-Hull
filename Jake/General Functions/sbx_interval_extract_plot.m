...
data = squeeze(sbxread('imgx(+)_000_000',frame_start,num_frames, '.sbx'));
load([fname, '.mat']);
...
img_ref = mean(data(:,:,100:200),3);
[reg_out, img_reg] = stackRegister(data, img_ref);
%img_reg = img_reg(:,:,[1:3:end])
writetiff(img_reg, 'Y:\home\jake\Data\2P_imaging\161103_img59\img59_tiff_motion_reg_1500');
